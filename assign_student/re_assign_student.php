                    ...
                    <form method="post" enctype="multipart/form-data">
                        <div class="row">
                            ...
                            <input type="hidden" name="shining_sheet_id" value="<?php if (isset($s_id)) {
                                    ...
                                    <input type="hidden" class="form-control" name="date" value="<?php date_default_timezone_set("Asia/Calcutta"); date('d-M-Y'); ?>" id="example-date-input" placeholder="Example input">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="radio" id="exampleInputEmail1" name="p_a" checked>
                                    <label for="exampleInputEmail1">Present</label>
                                    <input type="radio" id="exampleInputEmail2" name="p_a" >
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    <div class="form-check">
                                        <input type="checkbox" id="blankCheckbox" name="feed_back[]">
                                        <label for="blankCheckbox" class="mr-2">Excelent</label>
                                        <input type="checkbox" id="blankCheckbox1" name="feed_back[]">
                                        <label for="blankCheckbox1" class="mr-2">Very Good</label>
                                        <input type="checkbox" id="blankCheckbox2" name="feed_back[]">
                                        <label for="blankCheckbox2" class="mr-2">Good</label>
                                        <input type="checkbox" id="blankCheckbox3" name="feed_back[]">
