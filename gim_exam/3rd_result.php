...
<form action="" method="post">
    ...
    <?php 
        ...
        ?>
    <a href="clear_field.php?grid=<?php echo $grid; ?>"><button type="button" class="btn btn-success">
        Master Result</button></a>
        <?php } ?>
