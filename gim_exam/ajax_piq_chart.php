<?php 
    ...
    if($branch == 'All'){
        $que = "SELECT * FROM gim_students WHERE schedule_id='$schedule'";
    } else {
        $que = "SELECT * FROM gim_students WHERE branch='$branch' AND schedule_id='$schedule'";
    }
    ...
    for($i=0 ; $i<sizeof($arr) ; $i++){
        ...
        $g = $arr[$i];
        $qu = "SELECT * FROM gim_piq WHERE grid='$g'";
