...
<head>
    ...
    <title>GIM Student Result</title>
    <!-- Custom CSS -->
                ...
                <div class="navbar-header" data-logobg="skin5">
                    ...
                    <a class="navbar-brand" href="index.php">
                        ...
                        <b class="logo-icon p-l-10">
                            ...
                            <!-- Dark Logo icon -->
                            <img src="assets/images/rw_red.png" alt="homepage" class="light-logo" width="50"
                                height="50" />
                        ...
                        <!-- dark Logo text -->
                        <p class="text-danger"><b>RED</b> </p>&nbsp; <p>&</p> &nbsp;<p class="text-muted"> <b>White</b>
                        </p>
                        <br>
                        <!-- <center> -->
                        <!-- </center> -->
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav" class="p-t-30">
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                href="students.php" aria-expanded="false"><i class="fa fa-user" aria-hidden="true"></i><span
                                    class="hide-menu">Students</span></a></li>
                        <li class="sidebar-item"> <a class="sidebar-link" href="std_listing.php"
                                aria-expanded="false"><i class="mdi mdi-border-inside"></i><span class="hide-menu">Exam
                                    Center Students</span></a></li>

                        <li class="sidebar-item"> <a class="sidebar-link" href="add_logic.php" aria-expanded="false"><i
                                    class="mdi mdi-border-inside"></i><span class="hide-menu">Add Logic</span></a></li>
                        <!-- <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                href="grid.html" aria-expanded="false"><i class="mdi mdi-blur-linear"></i><span
                                    class="hide-menu">Full Width</span></a></li> -->


                        <li class="sidebar-item"><a href="final_master_res.php" class="sidebar-link"><i
                                    class="mdi mdi-note-outline"></i><span class="hide-menu"> Final Master Result
                                </span></a></li>
                        <li class="sidebar-item"><a href="master_list.php" class="sidebar-link"><i
                                    class="mdi mdi-note-outline"></i><span class="hide-menu"> Master List </span></a>
                        </li>


                        <?php if($_SESSION['isAdmin']==1) { ?>

                        <li class="sidebar-item"><a href="add_question.php" class="sidebar-link"><i
                                    class="mdi mdi-note-outline"></i><span class="hide-menu"> Add Question </span></a>
                        </li>

                        <li class="sidebar-item"><a href="search_result.php" class="sidebar-link"><i
                                    class="mdi mdi-note-outline"></i><span class="hide-menu"> Final Result </span></a>
                        </li>
                        <li class="sidebar-item"><a href="form-basic.php" class="sidebar-link"><i
                                    class="mdi mdi-note-outline"></i><span class="hide-menu"> Add Student </span></a>
                        </li>
                        <li class="sidebar-item"><a href="piq_chart.php" class="sidebar-link"><i
                                    class="mdi mdi-note-outline"></i><span class="hide-menu"> PIQ Summary </span></a>
                        </li>

                        <li class="sidebar-item"><a href="close_exam_admin.php" class="sidebar-link"><i
                                    class="mdi mdi-note-outline"></i><span class="hide-menu"> End Exam </span></a></li>
                        <li class="sidebar-item"><a href="add_user.php" class="sidebar-link"><i
                                    class="mdi mdi-note-outline"></i><span class="hide-menu"> Add User </span></a></li>


                        <li class="sidebar-item"><a href="result_field.php" class="sidebar-link"><i
                                    class="mdi mdi-note-outline"></i><span class="hide-menu"> Result Chart </span></a></li>

                        
                        <li class="sidebar-item"><a href="add_sedule.php" class="sidebar-link"><i
                        class="mdi mdi-note-outline"></i><span class="hide-menu"> Add Sedule </span></a></li>
