					...
					<div class="col-lg-12 mx-auto">
						<div class="coman_design_block_box">
	                        <div class="coman_design_block_title d-inline-block w-100 border-bottom">
	                            <h4 class="d-inline-block align-middle">Cancel Running Demo</h4>
	                        </div>
	                        <form>
	                            <div class="coman_design_block_box">	                                
		                                ...
		                                <div class="table_search_panel d-inline-block w-100">
		                                	<div class="row justify-content-center">
	                                			<div class="col-xl-4 col-lg-4 col-md-5 col-sm-5 col-12 mb-2 mb-xl-0 mb-lg-0 mb-md-0 mb-sm-0">
	                                				<button type="button" data-toggle="modal" data-target="#search_block" class="btn btn-info btn-block text-left filter_modal_btn">Filter Demo<span class="d-inline-block float-right"><i class="fas fa-exchange-alt"></i></span></button>
	                                			</div>
	                                ...
	                                <div class="coman_design_block_box">
                                        <div class="coman_design_block_title d-inline-block w-100 border-bottom pt-0">
                                            <h4 class="d-inline-block align-middle">Display Display 2020-03-07 To 2020-05-07 Cancel Demo Student</h4>
                                            <button type="button" class="btn btn-primary float-right">Download CSV</button>
                                        </div>
                                        <div class="coman_design_block_info">
                                            <div class="row">
                                                <div class="col-xl-12">
                                                    <div class="table-responsive">
                                                        <table class="table table-bordered create_responsive_table">
                                                            <tr class="thead">
                                                                <th>Demo Id</th>
                                                                <th>Demo Details</th>
                                                            ...
                                                            <tr class="demo_status_cancel demo_status_color">
                                                            	<td data-heading="Demo Id">5226</td>
                                                            	<td data-heading="Demo Details">
                                                            		<ul>
                                                            			<li>Virani Maulik</li>
                														<li>Mobile No : 
                														  <span class="phone_num"><a class="call_num" href="javascript:void(0)">9664719764</a>
                														    <ul class="phone_num_data">
                														      <li><a href="tel:9664719764" data-toggle="tooltip" title="" data-original-title="Call"><i class="fa fa-phone"></i></a> </li>
                														      <li><a href="#" data-toggle="tooltip" title="" data-original-title="Copy"><i class="fa fa-clone"></i></a> </li>
                														      <li><a href="#" data-toggle="tooltip" title="" data-original-title="Whatsapp"><i class="fa fa-whatsapp"></i></a> </li>
                														    </ul>
                														  </span>
                														</li>
                														<li>Total Attendance : 1</li>
                														<li>Leave From :18-03 To 23-3</li>
                														<li><a href="#student_datails_modal" class="student_status student_status_running d-inline-block p-1" data-toggle="modal">Attendance &amp; follow up</a></li>
                                                            		</ul>
                                                            	</td>
                                                            	...
                                                            	<td data-heading="Course" class="table_in_student_course">
                                                            		A. WEB DESIGNING AND DEVLOPING / 2019 >>
                                                            		CORE PHP, ILLUSTRATOR,PHOTOSHOP WEB,PHP FRAMWORK,HTML/CSS/SASS/LESS/BT ,SEO HOSTING,PERSON
                                                            	</td>
                                                            	<td data-heading="Branch Details">
                                                            		<ul>
                                                            			<li>YOGI CHOWK</li>
                                                            			<li>COMPUTER</li>
                                                            			<li>2019-04-08 04:55:10pm</li>
                                                            			<li>Added By - Shital Avaiya</li>
                                                            		</ul>
                                                            	</td>
                                                            	<td data-heading="Remarks">
                                                            		Hi No Remark
                                                            	</td>
				...
				<div class="row">
					<div class="col-lg-12">
						<div class="alert_bar_block">
							<div class="row">
								<div class="col-xl-3 col-lg-3 col-4 student_alert_bar demo_status_running">
									Running
								</div>
								<div class="col-xl-2 col-2 student_alert_bar demo_status_confusion">
									Confusion
								</div>
								<div class="col-xl-2 col-2 student_alert_bar demo_status_done">
									Done
								</div>
								<div class="col-xl-2 col-2 student_alert_bar demo_status_leave">
									Leave
								</div>
								<div class="col-xl-2 col-2 student_alert_bar demo_status_cancel">
									Cancel
								</div>
							</div>
						</div>
					...
					<div class="search_block d-inline-block w-100">
						<form class="col-lg-12">
							<div class="row">
								...
								<div class="col-lg-3 col-lg-4 col-md-4">
									<div class="form-group">
