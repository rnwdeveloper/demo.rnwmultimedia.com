	                            ...
	                            <div class="coman_design_block_box">	                                
	                                ...
	                                <div class="coman_design_block_box">
                                        <div class="coman_design_block_title d-inline-block w-100 border-bottom pt-0">
                                            <h4 class="d-inline-block align-middle">Display 2020-03-06 To 2020-05-06 ALL DEMO STUDENTS</h4>
                                                ...
                                                <div class="col-xl-12">
                                                    <div class="table-responsive">
                                                        <table class="table table-bordered create_responsive_table">
                                                            ...
                                                            <tr class="demo_status_leave demo_status_color">
                                                            	<td data-heading="Demo Id">5226</td>
                                                            	<td data-heading="Demo Details">
                                                            		<ul>
                                                            			<li>Virani Maulik</li>
                                                            ...
                                                            <tr class="demo_status_confusion demo_status_color">
                                                            	<td data-heading="Demo Id">5226</td>
                                                            	<td data-heading="Demo Details">
                                                            		<ul>
                                                            			<li>Virani Maulik</li>
