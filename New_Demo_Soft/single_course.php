                    ...
                    <div class="col-lg-12">
                        <div class="accordion accordion_design_2" id="student_list_aoc">
                                ...
                                <div class="card-header mb-0">
                                    <h2 class="mb-0">
                                          <button class="btn btn-link w-100 text-left collapsed" type="button" data-toggle="collapse" data-target="#student_filter_panel_1" aria-expanded="false">
                                                 Add Course <span class="d-inline-block float-right pluse_icon">✕</span>
                                          </button>
                                   </h2>
                                </div>
                                <div id="student_filter_panel_1" class="collapse show" data-parent="#student_list_aoc" style="">
                                    <div class="coman_design_block_box">
                                        <div class="coman_design_block_title d-inline-block w-100 border-bottom">
                                            <h4 class="d-inline-block align-middle">Add Course</h4>
                                        </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" value="" type="email" name="email" placeholder="Course Name" required>
                                                    </div>
                                                </div>
                                                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12">
                                                	<div class="form-group">
                                                ...
                                                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea class="form-control" rows="5" placeholder="Course Detail"></textarea>
                                                    </div>
                                                </div>
                                                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12">
                                                	<div class="form-group">
                            ...
                            <div class="card">
                                <div class="card-header mb-0">
                                    <h2 class="mb-0">
                                          <button class="btn btn-link w-100 text-left collapsed" type="button" data-toggle="collapse" data-target="#student_filter_panel_2" aria-expanded="false"> Display Course <span class="d-inline-block float-right pluse_icon">✕</span></button>
                                   </h2>
                                </div>
                                <div id="student_filter_panel_2" class="collapse" data-parent="#student_list_aoc" style="">
                                    <div class="coman_design_block_box">
                                        <div class="coman_design_block_title d-inline-block w-100 border-bottom">
                                            <h4 class="d-inline-block align-middle">Display Course </h4>
                                        </div>
                                                    ...
                                                    <div class="table-responsive">
                                                        <table class="table table-bordered table-striped create_responsive_table">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td data-heading="Course">C <a href="#" class="d-block action_icon" data-toggle="tooltip" title="Download Sign Sheet" download=""><i class="fas fa-download"></i></a></td>
                                                                ...
                                                                <td data-heading="Relevant Course Add">
                                                                	<button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#relevant_course_add">Relevant Course Add</button>
                                                                </td>
