							...
							<div class="right_side_row_panel_block collapse show" id="candidate_details" data-parent="#create_leade">
								...
								<div class="new_lead_info_fill" id="first_fifth_right_side">
									...
									<div class="form-group">
										...
										<textarea   class="form-control"  id="any_remarks" placeholder="Enter Remarks"  name="any_remarks"></textarea>
									</div>
...
<div class="modal fade" id="click_followup_remark_record">
	<div class="modal-dialog modal-dialog-centered modal-lg" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="change_type_name">Email</h5><br>
			...
			<div class="modal-body">
				<p id="subject_fol" style="color:grey;font-size: 16px;">Subject : <span id="followup_subject_name"></span></p><hr>
...
$(document).ready(function(){
	$('#lead_list_form_side_bar').validate({
		...
		messages:{
			...
			surname :{
				required : "<div style='color:red'>Please Enter Sur - Name</div>"
			},
			gender:{
