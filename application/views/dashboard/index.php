...
<?php @$user_permission =  explode(",",@$_SESSION['user_permission']);
  ...
  foreach($demo_all as $val) { if($val->discard=="0") { 
   ...
   if(in_array($val->branch_id,$branch_ids)  && in_array($val->department_id,$depart_ids) || $_SESSION['logtype']=="Super Admin" || $_SESSION['logtype']=="Receptionist") {
...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <?php $nos=0; foreach($upd_see as $val) { if($val->discard=="0") { if(in_array($val->branch_id,$branch_ids)  && in_array($val->department_id,$depart_ids) || $_SESSION['logtype']=="Super Admin" || $_SESSION['logtype']=="Faculty" || $_SESSION['logtype']=="hod") { $nos++; } } } ?> 
    <?php  if($nos!=0) {
      $dd = "";
       foreach($upd_see as $val) { if($val->discard=="0") { if(in_array($val->branch_id,$branch_ids)  && in_array($val->department_id,$depart_ids) || $_SESSION['logtype']=="Super Admin" || $_SESSION['logtype']=="Faculty") { 
             ...
             $dd = $dd." &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ".$val->name."( ".$val->startingCourse.") , ";
       } } }
      ?>
    <div class="col-md-12" >
    ...
    <!-- <div class="row">
      <div class="col-md-6">
        ...
        if(in_array($row->branch_id,$branch_ids) || $_SESSION['logtype']=="Super Admin") { ?>
              ...
              <div id="year_pie" style="width: 100%; height: 200px; margin: 0 auto"></div>
              <h3 id="tota_d">Total Demo :<span id="total_demo"></span></h3>
          </div>
          <div class="chart-box">
              <div id="3D_graf2" style="width: 100%; height: 200px; margin: 0 auto"></div>
              <h3 id="tota_d">Total Demo :<span id="demo_total"></span></h3>
          </div> 
      </div> 
      <div class="col-md-6" id="graph_wise_chart">
          <div class="chart-box">
              <div class="mbarchar">
          ...
          <div class="box-header with-border" style="margin-bottom:10px;">
            <form method="post" action="<?php echo base_url(); ?>welcome">
              <div class="row">
                ...
                <div class="col-md-2">
                  <select  class="form-control select2   " name="filter_package"  >
                    <option value="">Select Package</option>
                    <?php foreach($all_packages as $row) {  ?>
                    <option <?php if(@$filter_package == $row->package_name) { echo "selected"; }  ?> value="<?php echo $row->package_name; ?>"><?php echo $row->package_name; ?></option>
                    <?php } ?>
                  </select>
                </div>
                <div class="col-md-2">
              ...
              <div class="row">
                ...
                <div class="col-md-6" style="margin-top:15px;">
                  <div class="form-inline">
                    <input type="text"  class="form-control filterdatepicker input100" value="<?php if(!empty($filter_demoDate_start)) { echo $filter_demoDate_start; } ?>"  id="" name="filter_demoDate_start" placeholder="Start Date" >
                    <input type="text"  class="form-control filterdatepicker input100" value="<?php if(!empty($filter_demoDate_end)) { echo $filter_demoDate_end; } ?>"  id="" name="filter_demoDate_end" placeholder="End Date" >
                  </div>
                </div>
                <div class="col-md-2" style="margin-top:15px;">
                  <div class="col-sm-6">
                    <input type="submit" value="Filter" class="btn btn btn-success pull-right" name="search"/>
                  </div>
                  <div class="col-sm-6">
                            ...
                            <div class="modal-body" style="color:#000;">
                              ...
                              <div style="display:none; margin-Top:20px;" id="leavedate2<?php echo $val->demo_id; ?>">
                                ...
                                <div class="form-group">
                                  ...
                                  <input type="text" id="leaveto2<?php echo $val->demo_id; ?>" class="form-control willcomedate input100" id="" name="leave_to_date" placeholder="select date" >
                                </div>
                              </div>
                            </div>
                ...
                <div style="padding-top:5px;">
                  <div class="col-md-12">
                    ...
                    <form method="post" action="<?php echo base_url(); ?>welcome">
                      ...
                      <?php if(in_array("Take Attendance=1",$user_permission) || $_SESSION['logtype']=="Super Admin" || $_SESSION['logtype']=="Receptionist") { ?>
                      <div class="col-md-2">
                        <label class="radio-inline">
                        <input type="radio" checked id="radioP2" name="att" onclick="whichSelect2(<?php  echo $val->demo_id; ?>,'P')" value="P">P
                        </label>
                ...
                <div style="padding-top:5px;">
                  <div class="col-md-12">
                    ...
                    <form method="post" action="<?php echo base_url(); ?>welcome">
                      ...
                      <div class="col-md-1">
                        <input type="hidden" name="demo_id" value="<?php  echo $val->demo_id; ?>">
                        <?php if(in_array("Take Attendance=1",$user_permission) || $_SESSION['logtype']=="Super Admin" || $_SESSION['logtype']=="Receptionist" || $_SESSION['logtype']=="Accountant") { ?>
                        <button type="button" style="display:none;" id="modal_button2<?php  echo $val->demo_id; ?>"  class="btn btn-sm btn-default pull-right" data-toggle="modal" data-target="#myModal_cancel2<?php echo $val->demo_id; ?>">Submit</button>
                        <input type="submit" id="formsubmit2<?php  echo $val->demo_id; ?>" name="take_attendance" value="Submit" class="btn btn-sm btn-default pull-right">
                        <?php } ?>
                      </div>
...
<script type="text/javascript">
  $(document).ready(function(){
     ...
     else if(key == "Six Month")
     {
      var now = new Date();
       lastWeek = new Date(now.setMonth(now.getMonth() - 6));
      var sortByQueryString = 
    '&fq=lastmodified:[' + lastWeek.toISOString() + '+TO+NOW]';
     }
     else if(key == "Three Month")
     {
         var lastWeek = new Date();
       lastWeek.setMonth(lastWeek.getMonth() - 3);
     }
     ...
     else if(key == "One Year")
     {
       var today = new Date();
        var lastWeek = today.getFullYear() - 1;
      }
