         ...
         <div class="row">
            <div class="col-xl-12">
               <div class="extra_Block_box">
                  ...
                  <input type="hidden" name="status_of_record" id="status_of_record" value="<?php echo $followup_status_wise['status_of_record']; ?>">
                  <div class="menu_bottom_btn_row">
                     ...
                     Today's Followups - <?php echo trim($followup_status_wise['ALL']);  ?>
                     <?php }else { ?>	
                     Followups on <?php echo $followup_status_wise['date_record'] ?> (0) 
                     <?php } ?>
                     </a>
                     ...
                     <div style="border-top: 1px solid orange; margin-bottom: 23px; margin-top:11px;padding-top:20px;">
                        <a href="<?php echo base_url();?>LeadMyActivity/index" style="color:rgb(0,0,255); font-weight: bold;font-size: 14px; margin-left: 10px; display: inline-block;">ALL (<?php echo @$followup_status_wise['ALL']; ?>)</a>
                  ...
                  <div class="full_lead_block scrollbar-rail d-inline-block w-100 position-relative">
                     <img src="<?php echo base_url(); ?>images/Loader_crm.gif" height="60" width="60" style="position: absolute;text-align:center; line-height:400px; margin-left:50%; margin-top:20%;" id="Loader_data" >
                     <?php 
                           ...
                           <ul>
                              <li class="prospect_neme_first_list">
                                 ...
                                 <div class="lead_info_text position-relative ">
                                    <a href="#" class="lead_info_text"  onclick="return update_lead_record(<?php echo $lla->lead_list_dupli_id; ?>);"><u><?php echo $lla->name; ?></u></a>
               ...
               <form method="post" id="lead_list_form_side_bar" class="view_hide_side_bar">
                  <div class="fill_new_leade_info_body" id="create_leade">
                     <div class="right_side_row_panel">
                        <a href="#candidate_details" data-toggle="collapse"  class="collapsed candidate_details"><i class="fas fa-chevron-down"></i>  Lead Details</a>
                        <div class="right_side_row_panel_block collapse show" id="candidate_details" data-parent="#create_leade">
                           ...
                           <div class="new_lead_info_fill" id="first_third_right_side">
                              ...
                              <div class="form-group">
                                 ...
                                 <textarea   class="form-control"  id="followup_remark" placeholder="Enter Remarks"  name="followup_remark"></textarea>
                              </div>
                           </div>
                           ...
                           <div class="new_lead_info_fill" id="first_fifth_right_side">
                              ...
                              <div class="form-group">
                                 ...
                                 <textarea   rows="6" class="form-control"  id="any_remarks" placeholder="Enter Remarks"  name="any_remarks"></textarea>
                              </div>
                           </div>
                        </div>
                     </div>
...
<script>
   $(document).ready(function(){ 
   	// alert("alert");
   	var calendar = $('#calendar_record').fullCalendar({
   		editable:true,
   	   header:{
...
<script type="text/javascript">
   ...
   $('#change_lead_status').html("Followup Calendar");
...
<script>
   ...
   $(document).ready(function(){
   	...
   	$('#lead_list_form_side_bar').validate({
   		...
   		submitHandler: function() { 
      			...
      			var status_of_record = $('#status_of_record').val();
   			...
   			$.ajax({
   				...
   				url : "<?php echo base_url(); ?>LeadMyActivity/lead_list_add",
   ...
   
   				{
   					...
   					$.ajax({
   						...
   						data 	: { 'start' : start_date, 'status_wise': status_of_record, 'status_f' : filter_name },
   	...
   	// alert(lead_list_id);		
   		...
   		$.ajax({
   ...
   
   			{
   				...
   				// var next_action = data.record['lead_get_record'].next_action_date;
   				...
   				// var res = next_action.split(" ");
   
   				// $('#next_followup_date').val(res[0]);
   
   				// var timing = res[1]+" "+res[2];
   
   				// $('#next_followup_time').val(timing);
   				...
   				$('#father_name').val(data.record['lead_get_record'].father_name);
   
   				$('#father_mobile_no').val(data.record['lead_get_record'].father_mobile_no);
   
   				$('#tenth_board').val(data.record['lead_get_record'].tenth_board);
   
   				$('#tenth_perc').val(data.record['lead_get_record'].tenth_perc);
   
   				$('#tweth_board').val(data.record['lead_get_record'].tweth_board);
   
   				$('#tweth_perc').val(data.record['lead_get_record'].tweth_perc);
   
   
   
   				$('#degree').val(data.record['lead_get_record'].degree);
   
   				$('#degree_perc').val(data.record['lead_get_record'].degree_perc);
   ...
   $(document).ready(function(){
   	...
   	jQuery('.scrollbar-rail').scroll(function(){
   		 ...
   		 var status_record = $('#status_of_record').val();
...
<script type="text/javascript">
   ...
   function show_email_template(lead_id){
   	...
   	$.ajax({
   		...
   		url: "<?php echo base_url(); ?>LeadMyActivity/get_lead_record",
   ...
   
   {
   ...
   
   	{
   		...
   		$.ajax({
   				...
   				url: "<?php echo base_url(); ?>LeadMyActivity/send_email",
   ...
   
   {
   	...
   	$.ajax({
   		...
   		url : "<?php echo base_url();  ?>LeadMyActivity/get_lead_followup_record",
   ...
   
   	{
   		...
   		$.ajax({
   ...
   
   				{
   					...
   					var status_wise  = $('#status_of_record').val();
   					...
   					$.ajax({
   						...
   						data 	: { 'start' : start_date,'status_wise':status_wise,'test':'test' },
...
<script>
   ...
   $('#calendar_record').show();
    ...
    function get_activity_wise_record(status){
   
    	 var start = $('#start_date').val();
   
    	 $('#status_of_record').val(status);
         ...
         data:{'start':start,'status_wise':status,'st_update_status':'status_record_all'},
