                    ...
                    <div class="col-lg-12">
                        <div class="accordion accordion_design_2" id="student_list_aoc">
                                ...
                                <div class="card-header mb-0">
                                    <h2 class="mb-0">
                                          <button class="btn btn-link w-100 text-left collapsed" type="button" data-toggle="collapse" data-target="#student_filter_panel_1" aria-expanded="false">
                                                 Lead Follow-up Mode <span class="d-inline-block float-right pluse_icon">✕</span>
                                          </button>
                                   </h2>
                                </div>
                                <div id="student_filter_panel_1" class="collapse show" data-parent="#student_list_aoc" style="">
                                    <div class="coman_design_block_box">
                                        <div class="coman_design_block_title d-inline-block w-100 border-bottom">
                                            <h4 class="d-inline-block align-middle">Add Followup Modes</h4>
                                        </div>
                                        <form class="coman_design_block_info" method="post" action="<?php echo base_url(); ?>LeadlistController/lead_followup_mode">
                                            <div class="row">
                                                
                                               
                                                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12">
                                                    <div class="form-group">
                                                        <label for="pwd">Add Followup Mode:</label>
                                                        <input class="form-control" type="text" name="follow_up_mode_name" placeholder="Enter Followup mode" required value="<?php if(isset($followup_mode->follow_up_mode_name)){ echo @$followup_mode->follow_up_mode_name; } ?>">
                                                    </div>
                                                </div>
                                                
                                                <input class="form-control" type="hidden" name="follow_up_mode_id" required value="<?php if(isset($followup_mode->follow_up_mode_id)){ echo @$followup_mode->follow_up_mode_id; } ?>">
                            ...
                            <div class="card">
                                <div class="card-header mb-0">
                                    <h2 class="mb-0">
                                          <button class="btn btn-link w-100 text-left collapsed" type="button" data-toggle="collapse" data-target="#student_filter_panel_2" aria-expanded="false"> Display Followup Mode <span class="d-inline-block float-right pluse_icon">✕</span></button>
                                   </h2>
                                </div>
                                <div id="student_filter_panel_2" class="collapse" data-parent="#student_list_aoc" style="">
                                    <div class="coman_design_block_box">
                                        <div class="coman_design_block_title d-inline-block w-100 border-bottom">
                                            <h4 class="d-inline-block align-middle">Display Followup Mode</h4>
                                        </div>
                                                ...
                                                <div class="col-xl-12">
                                                    <div class="table-responsive">
                                                        <table class="table table-bordered table-striped create_responsive_table display"  id="example"  style="width:100%">
                                                          ...
                                                          <tbody>
                                                            <?php foreach($list_followup_mode as $cl){ ?>
                                                          
                                                            <tr>
                                                               
                                                                <td data-heading="Branch"><?php echo $cl->follow_up_mode_name; ?></td>
                                                                ...
                                                                <td data-heading="Action">
                                                                    <ul class="action_icon_block icon_not_manage">
                                                                        <li>
                                                                            <a href="<?php echo base_url(); ?>LeadlistController/lead_followup_mode?action=update&id=<?php echo $cl->follow_up_mode_id; ?>"class="action_icon action_edit" data-toggle="tooltip" title="Edit"><i class="fas fa-edit"></i></a>
                                                                        </li>
                                                                        <li>
                                                                            <a href="<?php echo base_url(); ?>LeadlistController/lead_followup_mode?action=delete&id=<?php echo $cl->follow_up_mode_id; ?>" class="action_icon action_delete" data-toggle="tooltip" title="Delete"><i class="fas fa-trash-alt"></i></a>
                                                                        </li>
                                                                        <li>
