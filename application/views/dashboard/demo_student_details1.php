...
<div id="demo_update_record">
	<?php if(@$this->session->flashdata('msg_alert1')) { ?>

	<div class="alert alert-success alert-dismissible">
		<button type="button" class="close" data-dismiss="alert">&times;</button>
		<?php echo $this->session->flashdata('msg_alert1'); ?></div>
<?php } ?>
...
<div class="modal-header">
					...
					<div class="btn-group">
						...
						<button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#myModal_cancel">Discard</button>
