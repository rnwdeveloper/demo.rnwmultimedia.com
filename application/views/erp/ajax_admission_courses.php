...
<div class="modal-body">
                                          ...
                                          <ul>
                                             <li class="d-inline-block mr-3 mr-mr-0">
                                                <div class="form-check form-check-inline">
                                                   <input class="form-check-input" type="radio" id="course_package" name="type" value="package" onclick="return show_hide_package_course()" />Package1
                                                </div>
                                                <div class="form-check form-check-inline">
   ...
   <?php $no = "1"; ?>
   <input type="text" value="<?php if (isset($no)) {
      echo $no;
      } ?>" class="form-control custom-form-control number" />
   </div>
   </div>
