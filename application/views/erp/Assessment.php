...
<style type="text/css">
   ...
   .faculty_behavior_mark{
   margin-left: 130px;
   font-size: 10px !important;
   }
   .student_behavior_mark{
   margin-left: 110px;
   font-size: 10px !important;
   }
   .total_work_days{
...
<section>
   ...
   <div class="col-sm-12 col-md-6">
         ...
         <div class="card-body">
            <table class="table table-bordered mb-0">
               ...
               <tbody>
                  <tr>
                     <td>
                        <div class="col-sm-12 checkbox p-0">
            ...
            <span class="uniform"><?php echo $previous_adm_data->uniform; ?></span>
            <span class="discipline"><?php echo $previous_adm_data->discipline; ?></span>
            <span class="faculty_behavior_mark"><?php echo $previous_adm_data->faculty_behavior_mark; ?></span> 
            <span class="student_behavior_mark"><?php echo $previous_adm_data->student_behavior_mark; ?></span> 
            </label>
            <?php } ?>
            </div>
         </div>
      ...
      <div class="col-sm-12 col-md-4">
         <div class="card mb-3">
            ...
            <div class="card-body">
               ...
               <label>
               <span style="color: red; font-size: 10px !important;" >previous</span>
               <span class="total_work_days"><?php echo $previous_adm_data->total_work_days; ?></span>
               <span class="total_present_days"><?php echo $previous_adm_data->total_present_days; ?></span>
               <span class="total_attendance_percentage"><?php echo $previous_adm_data->total_attendance_percentage; ?></span> 
               </label>
               <?php } ?>
            </div>
         </div>
      ...
      <div class="col-sm-12 col-md-4">
         <div class="card mb-3">
            ...
            <div class="card-body">
               <div class="form-row">
                  <div class="form-group col-md-3">
                     <label for="inputEmail4">Total Project</label>
                     <input type="number" class="form-control" name="total_project" id="total_project" min="0" value="0" >
                     <input type="hidden" class="form-control" name="">
                  </div>
                  <div class="form-group col-md-3">
                     <label for="inputPassword4">Submited</label>
                     <input type="number" class="form-control" name="submited" id="submited" min="0" value="0" onchange="submitevalue()">
                     <b><span id="pro" class="pr"></span><input type="hidden" name="" id="submited_percentage"></b>
                  </div>
                  <div class="form-group col-md-3">
                     <label for="inputEmail4">On Time</label>
                     <input type="number" class="form-control" name="on_time" id="on_time" min="0" value="0" onchange="projectwork()">     
                     <b><span id="project"  class="pr"></span><input type="hidden" name="" id="on_time_percentage"></b> 
                  </div>
                  <div class="form-group col-md-3">
                     <label for="inputPassword4">Quality</label>
                  ...
                  <label>
                  <span style="color: red; font-size: 10px !important;" >previous</span>
                  <span class="total_project"><?php echo $previous_adm_data->total_project; ?></span>
                  <span class="submited"><?php echo $previous_adm_data->submited; ?>|<?php echo $previous_adm_data->submited_percentage; ?></span>
                  <span class="on_time"><?php echo $previous_adm_data->on_time; ?>|<?php echo $previous_adm_data->submited_percentage; ?></span> 
                  <span class="quality"><?php echo $previous_adm_data->quality; ?></span> 
                  </label>
                  <?php } ?>
               </div>
            </div>
      ...
      <button type="submit" name="submit" id="assessment_ins" class="btn btn-success ml-3">Submit</button>
   </div>
</section>
