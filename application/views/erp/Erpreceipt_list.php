                ...
                <div class="card-body">
                  <div class="table-responsive">
                    <table class="table table-striped income-table" id="table1">
                      ...
                      <tbody>
                        <?php $sno = 1;
                        foreach ($erp_receipt_list as $val) { if ($val->deleted_status == "0") { ?>
                          <tr>
                            <td>
                            ...
                            <td>
                              <?php for($i=0;$i<sizeof($all_per);$i++) { if($all_per[$i] == "View Receipt") { ?>
                              ...
                              <?php } }?>
                              <?php for($i=0;$i<sizeof($all_per);$i++) { if($all_per[$i] == "Delete Receipt") { ?>
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method="post" action="<?php echo base_url(); ?>Account/Erpreceipt_list">
          <div class="form-row">
            ...
            <div class="form-group col-md-3">
              <label for="inputPassword4">Transaction NO</label>
              <input type="text" class="form-control" id="" name="filter_transaction_no" value="<?php if (!empty($filter_transaction_no)) {
                                                                                              echo @$filter_transaction_no;
                                                                                            } ?>" placeholder="Transaction No">
            </div>
            <div class="form-group col-md-3">
              <label for="inputPassword4">Cheque/DD NO</label>
              <input type="text" class="form-control" id="" name="filter_cheque_dd_no" value="<?php if (!empty($filter_cheque_dd_no)) {
                                                                                              echo @$filter_cheque_dd_no;
          ...
          <div class="text-right mt-2">
            ...
            <a class="btn btn-light text-dark" href="<?php echo base_url(); ?>Account/Erpreceipt_list">Reset</a>
          </div>
        </form>
      </div>
    </div>
