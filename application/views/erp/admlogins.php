...
<main  class="main_content d-inline-block">
  ...
  <div class="card-header">
    <ul class="nav nav-tabs card-header-tabs">
      ...
      <li class="nav-item">
        <a class="nav-link active" href="<?php echo base_url(); ?>AddmissionController/admlogins?action=edit&id=<?php echo @$admission->admission_id; ?>"><b>Logins</b></a>
      </li>
      <li class="nav-item">
    ...
    <p class="card-text">
      <div class="form-row">
          <div class="form-group col-md-2">
            <span><b>Guardian 1 Details:</b></span>
          </div>
          <div class="form-group col-md-3">
            <span><b>Father Name :</b> <?php echo @$admission->father_name; ?></span> <br>
            <span><b>Phone :</b> -NA-</span>
          </div>
          <div class="form-group col-md-3">
           <span><b>Emial :</b> <?php echo @$admission->father_email; ?></span> <br>
            <span><b>Income :</b> <?php echo @$admission->father_income; ?></span>
          </div>
          <div class="form-group col-md-3">
          <span><b>Father Mobile :</b> <?php echo @$admission->father_mobile_no; ?></span>
            <span><b>Occupation :</b> -NA-</span>
          </div>
          <div class="form-group col-md-2">
           <span><b>Guardian 2 Details:</b></span>
          </div>
          <div class="form-group col-md-3">
             <span><b>Mother Name :</b> <?php echo @$admission->mother_name; ?></span> <br>
            <span><b>Phone :</b> -NA-</span>
          </div>
          <div class="form-group col-md-3">
            <span><b>Emial :</b> <?php echo @$admission->mother_email; ?></span> <br>
            <span><b>Income :</b> <?php echo @$admission->mother_income; ?></span>
          </div>
          <div class="form-group col-md-3">            
          <span><b>Mother Mobile :</b> <?php echo @$admission->mother_mobile_no; ?></span>
            <span><b>Occupation :</b> -NA-</span>
          </div>

          
     <span><b>Guardian Portal Login Id :</b><?php echo @$admission->father_email; ?></span>
  </div>
</div>
