              ...
              <div class="col-12">
                <div class="card">
                  <div class="card-header d-flex justify-content-between income-wrapper">
                    <?php 
                    $total =0;
                    for($i=0; $i<sizeof($income_list); $i++) {  
                      $total = $total + $income_list[$i]->pay_now;
                    }?> 
                  ...
                  <div class="card-body">
                    <div class="table-responsive">
                      <table class="table table-striped income-table tabel-ordered" id="table1">
                        ...
                        <tbody>
                          <?php $sno=1; foreach($income_list as $val) { if($val->deleted_status=="0") { ?>
                          <tr>
                            <td><?php echo $sno; ?></td>
                            <td>
                              <?php $admids = explode(",",$val->admission_id);
                              foreach($admisison_process_data as $row) { if(in_array($row->admission_id,$admids)) { ?>
                             <?php  echo $row->surname." ".$row->first_name."<br>". "<strong>GR ID : </strong>".$row->gr_id."<br>"; "<strong>(RNW/Year </strong>".$row->year."/".$row->enrollment_number."<strong>)</strong>"."<br>"?>
                            ...
                            <td>
                              ...
                              <?php echo "<strong>P : </strong>".$val->receipt_date."<br>"; ?>
                              <?php echo "<strong>C : </strong>".$val->receipt_date."<br>";?>
                              <?php echo "<strong>Pay Mode By : </strong>".$val->ramrk_by."<br>"; ?>
                              <?php echo "<strong>Received By : </strong>".$val->received_by; ?>
                            </td>
                            <td><?php echo $val->pay_now; ?></td>
                            <td>0</td>
                            <td><?php echo $val->pay_now; ?></td>
                            <td><a href="#" class="btn btn-success text-white">Cleared Active</a></td>
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form method="post" action="<?php  echo base_url(); ?>Account/income">
         <div class="form-row">
        ...
        <div class="col-md-6 form-group" >
         ...
         <div class="text-right">
          ...
          <a class="btn btn-light text-dark" href="<?php echo base_url(); ?>Account/income">Reset</a>  
        </div>
        </form>
        </div>
      </div>
