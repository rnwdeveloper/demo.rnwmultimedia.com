    ...
    <div class="col-lg-2">
        ...
        <label><strong>#NO</strong></label> 
          ...
          if(!empty($data['payment_details']->installment_no)){
              ...
              $no =@$data['payment_details']->installment_no+1; 
  	...
  	<div class="col-lg-3"> 
        <div class="form-group">
          ...
          <input type="text" class="form-control" name="installment_date_first" id="installment_date_first" value="<?php echo $currentTime; ?>">
        </div>
    </div>
    <div class="col-lg-3"> 
    	<div class="form-group">
...
else if(!empty($data['payment_details']->installment_no)){
