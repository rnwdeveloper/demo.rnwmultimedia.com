          ...
          <div class="row">
            <div class="col-12">
              <div class="card">
                ...
                <?php 
                    $total =0;
                    for($i=0; $i<sizeof($list_expenses); $i++) { if($list_expenses[$i]->expense_status=="1") {  
                      $total = $total + $list_expenses[$i]->paying_amount;
                    } }?> 
                  <h4>Expenses Deleted</h4>
                    ...
                    <table class="table table-striped income-table tabel-ordered" id="table1">
                      <thead>
                        <tr>
                          ...
                          <th>NO</th>
                          <th width="400px" align="left">Payment Details</th>
                          <th>Branch</th>
                          <th>Category</th>
                          <th>Payee</th>
                          <th>Amount (₹)</th>
                          <th>Payment Mode</th>
                          <th width="500px" align="left">Details</th>
                          <th>Remark</th>
                          <th>Paid By</th>
                          <th>Created By</th>
                      ...
                      <tbody>
                        <?php $sno = 1;
                        foreach ($list_expenses as $val) { if($val->expense_status=="1") {?>
                          <tr class="notas">
                            <!-- <td>
        ...
        <div id="msg_expenses"></div>
          <div class="form-row">
            ...
            <div class="form-group col-md-4">
              ...
              <input type="text" class="form-control" id="paying_amount" name="paying_amount" value="" placeholder="Expenses Amount" required>
            </div>
            <div class="form-group col-md-4">
              <label for="inputEmail4">Details</label>
              <input type="text" class="form-control" id="info" name="info" value="" placeholder="Expenses..." required>
            </div>
            <div class="form-group col-md-4">
            ...
            <div class="form-group col-md-4">
              <label for="inputEmail4">Payee Label</label>
...
<script type="text/javascript">    
      $(function () {    
          $("#btnExporttoExcel").click(function () {    
              $("#table1").table2excel({    
                  filename: "Expenses-dlt-data.xls"    
              });    
          });    
      });    
</script>  
