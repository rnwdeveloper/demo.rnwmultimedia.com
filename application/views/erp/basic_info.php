...
<main  class="main_content d-inline-block">
  ...
  <div class="card-header">
    <ul class="nav nav-tabs card-header-tabs">
      <li class="nav-item">
        <a class="nav-link active" href="<?php echo base_url(); ?>AddmissionController/basic_info?action=edit&id=<?php echo @$admission->admission_id; ?>"><b>Basic Info</b></a>
      </li>
      <li class="nav-item">
    ...
    <p class="card-text">
      <div class="form-row">
          <div class="form-group col-md-3">
            <span><b>Rf Name :</b> -NA-</span>
          </div>
          <div class="form-group col-md-3">
            <span><b>Rf Mobile :</b> -NA-</span>
          </div>
          <div class="form-group col-md-3">
           <span><b>Landline No :</b> -NA-</span>
          </div>
          <div class="form-group col-md-2">
           <span><b>Address :</b> <?php echo @$admission->present_address;?></span>
          </div>
          <div class="form-group col-md-3">
            <span><b>Country :</b> <?php echo @$admission->country_id;?></span>
          </div>
          <div class="form-group col-md-3">
             <span><b>Status :</b> -NA-</span>
          </div>
          <div class="form-group col-md-3">
            <span><b>Cancel/Term Date :</b> -NA-</span>
          </div>
          <div class="form-group col-md-3">            
          <span><b>Additional Info :</b> -NA-</span>
          </div>

          
     <a href="#" class="btn btn-warning">Admission Cancel</a>
  </div>
</div>
