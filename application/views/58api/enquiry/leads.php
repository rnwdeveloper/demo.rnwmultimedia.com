 ...
 <!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    ...
    <div style="margin-left: 250px; margin-top: -40px;">
      <a href="<?php echo base_url() ?>Enquiry/proceedEnq" class="btn btn-success">NewEnquery</a>
      <a href="<?php echo base_url() ?>Enquiry/inquirys" class="btn btn-info">EnqueryList</a>
      <a href="<?php echo base_url() ?>Enquiry/enquiryPendingFollowup" class="btn btn-primary">CurrentMonth</a>
       <a href="<?php echo base_url() ?>Enquiry/enquiryOverdueFollowup" class="btn btn-warning">EnquiryOverdueFollowup</a>
    </div>
    <?php } ?>
      <ol class="breadcrumb">
