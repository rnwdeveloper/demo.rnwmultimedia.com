 ...
 <!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    ...
    <div style="margin-left: 400px; margin-top: -40px;"> 
      <a href="<?php echo base_url() ?>Enquiry/leads_list" class="btn btn-success">Leads</a>
      <a href="<?php echo base_url() ?>Enquiry/proceedEnq" class="btn btn-info">NewEnquery</a>
      <a href="<?php echo base_url() ?>Enquiry/enquiryPendingFollowup" class="btn btn-warning">PendingFollowup</a>
       <a href="<?php echo base_url() ?>Enquiry/enquiryOverdueFollowup" class="btn btn-danger">OverdueFollowup</a>
    </div>
    <?php } ?>
      <ol class="breadcrumb">
        <li><a href="<?php echo base_url(); ?>"><i class="fa fa-dashboard"></i> Home</a></li>
       
        <li class="active"><a href="<?php echo base_url(); ?>Enquiry/leads_list">Enquiry List</a></li>
          ...
          <div class="box box-success" style="padding:20px;">
            <div class="box-header with-border">
              ...
              <h3 class="box-title">
                   ...
                   Enquiry List(Count: <?php echo $to; ?>)</h3>
  ...
  <div class="modal fade" id="myModal_filter" role="dialog">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <form method="post" action="<?php  echo base_url(); ?>Enquiry/inquirys">
        <div class="modal-body">
        ...
        <div class="modal-footer">
          ...
          <a class="btn btn-primary" href="<?php echo base_url(); ?>Enquiry/inquirys">Reset</a>
        </div>
        </form>
      </div>
    </div>
                ...
                <tr>
                 ...
                 <?php } ?>
                  ...
                  <td>
                      ...
                      <?php if(!empty($val->enquiry_follwup_comment)) { echo $val->enquiry_follwup_comment; }  ?>
                      
                  </td>
                  <td><?php foreach($all_user as $user) { if($user->user_id==$val->enquiry_assignedUser) { echo $user->email."<br>"; } } ?>
                    <?php   echo "Added By<br>"; ?>
                    <?php echo $val->enquiry_addedBy; ?>
                    </td>
                  <td><?php foreach($all_branch as $bran) { if($bran->branch_id==$val->enquiry_branch) { echo $bran->branch_name; } } ?></td>
                  <td>
