 ...
 <!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    ...
    <div style="margin-left: 440px; margin-top: -40px;"> 
      ...
      <a href="<?php echo base_url() ?>Enquiry/inquirys" class="btn btn-warning">EnqueryList</a>
       <a href="<?php echo base_url() ?>Enquiry/enquiryPendingFollowup" class="btn btn-danger">PendingFollowup</a>
    </div>
    <?php }  ?>
      <ol class="breadcrumb">
        <li><a href="<?php echo base_url(); ?>"><i class="fa fa-dashboard"></i> Home</a></li>
       
        <li class="active"><a href="<?php echo base_url(); ?>Enquiry/enquiryOverdueFollowup">Overdue Follow Ups</a></li>
        ...
        <div class="col-md-12" >
          ...
          <div class="box box-success" style="padding:20px;">
            <div class="box-header with-border">
              ...
              <h3 class="box-title">Overdue Follow Ups (Count: <?php echo $to; ?>)</h3>
  ...
  <div class="modal fade" id="myModal_filter" role="dialog">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <form method="post" action="<?php  echo base_url(); ?>Enquiry/enquiryOverdueFollowup">
        <div class="modal-body">
        ...
        <div class="modal-footer">
          ...
          <a class="btn btn-primary" href="<?php echo base_url(); ?>Enquiry/enquiryOverdueFollowup">Reset</a>
        </div>
        </form>
      </div>
    </div>
