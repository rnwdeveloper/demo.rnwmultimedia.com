          ...
          <div class="section-body">
            <div class="row">
              <div class="col-12 d-flex flex-wrap justify-content-between">
                <h6 class="page-title text-dark mb-3">Job Sub Category</h6>
                <nav aria-label="breadcrumb">
                  <ol class="breadcrumb p-0">
                    <li class="breadcrumb-item"><a href="#">Home</a></li>
                    <li class="breadcrumb-item"><a href="#">Jobs</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Job Sub Category</li>
                  </ol>
                </nav>
              </div>
              <div class="col-12">
                <div class="card">
                  <div class="card-header">
                      <div class="ml-auto">
                          <a href="#" class="btn btn-info text-white" data-toggle="modal" data-target=".add_job_sub_category">
                      ...
                      <table class="table table-striped normal-table" id="table1">
                        ...
                        <tbody>
                          <tr>
                            ...
                            <td>Multimedia</td>
                            <td>Web Designer</td>
                            <td>HTML, CSS, Bootstrap & Java Script (Front end Coding)</td>
                            <td>2020-07-20 22:53:56</td>
                            <td>
                              <a href="" data-toggle="modal" data-target=".add_job_sub_category" class="bg-primary action-icon text-white btn-primary"><i class="fas fa-pencil-alt"></i></a>
...
<div class="modal fade add_job_sub_category" tabindex="-1" role="dialog" aria-labelledby="add_job_sub_category"
    aria-hidden="true">
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title text-dark" id="add_job_sub_category">Add Job Subcategory</h5>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="" id="">
                                    <option value="">Select Job Main Category</option>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="" id="">
                                    <option value="">Select Job Position Category</option>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" placeholder="Job SubCategory">
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
