...
.rating-stars ul > li.star.selected > i.fa {
 ...
 <!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    ...
    <!-- Main content -->
 <a href="javascript:add_category()"  style="margin-left:50px; padding:5px; background-color: violet; color:white;">Add Job Category</a>
              ...
              <table  id="example1"  class="table table-bordered table-striped">
                ...
                <tbody>
                  <?php foreach($position as $pos) { ?>
                    <tr>
                        <td><?php echo $pos->job_category_id; ?></td>
                        <td><?php echo $pos->job_category_name; ?></td>
                        <td><?php echo $pos->job_created_date; ?></td>

                        <td><a href="javascript:delete_job(<?php echo $pos->job_category_id; ?>)" style="color:red"><i class="fa fa-trash" aria-hidden="true"></i></a>
                          <a href="javascript:update_job(<?php echo $pos->job_category_id; ?>)"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a></td>
                    </tr>
                  <?php } ?>
...
<script>
  ...
  function delete_job(id)
  {
    ...
    if(conf){
        $.ajax({
          url : "<?php echo base_url(); ?>FormController/delete_job_catgory/",
          type :"post",
          data:{
            'job_post_id' : id
          },
...
<div id="show_modal" class="modal fade" role="dialog" >
  <div class="modal-dialog" style="width:600px !important;">
    <div class="modal-content">
     ...
     <form method="post" name="add_job_category" id="add_job_category">  
      <table class="table table-bordered table-striped">
          <thead >
            <tr>
              <td>Job Position Category</td>
              <td><input type="text" name="job_category_name" id="job_category_name" class="form-control">
              </td>
              <input type="hidden" name="job_category_id_r" id="job_category_id_r">
            </tr>
            <tr>
              <td></td>
...
$( "#add_job_category" ).validate({
  ...
  submitHandler: function () {
       ...
       var formdata =  $('#add_job_category').serialize();

       $.ajax({
          url : "<?php echo base_url(); ?>FormController/add_record_jobCategory",
          type : "post",
          data: formdata,
          success:function(resp)
          {
...
function update_job(jobPosId){
  $.ajax({
     url : "<?php echo base_url(); ?>FormController/update_job_category_position",
     type : "post",
     data:{
     ...
     success:function(resp)
     {
      $("#show_modal").modal();
      var data = $.parseJSON(resp);
      var job_position_name = data['single_record'].job_category_name;
      var job_position_id = data['single_record'].job_category_id;
      $('#job_category_name').val(job_position_name);
      $('#job_category_id_r').val(job_position_id);
      $('#submit').val('Update');
     }
