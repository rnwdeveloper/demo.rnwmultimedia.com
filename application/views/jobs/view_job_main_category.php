          ...
          <div class="section-body">
            <div class="row">
              <div class="col-12 d-flex flex-wrap justify-content-between">
                <h6 class="page-title text-dark mb-3">Job Main Category</h6>
                <nav aria-label="breadcrumb">
                  <ol class="breadcrumb p-0">
                    <li class="breadcrumb-item"><a href="#">Home</a></li>
                    <li class="breadcrumb-item"><a href="#">Jobs</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Job Main Category</li>
                  </ol>
                </nav>
              </div>
              <div class="col-12">
                <div class="card">
                  <div class="card-header">
                      <div class="ml-auto">
                          <a href="#" class="btn btn-info text-white mb-3" data-toggle="modal" data-target=".add_job_main_category">
                              <span data-toggle="tooltip" data-placement="bottom" title="Add Job Category"><i
                                      class="fa fa-plus text-white"></i></span>
                          </a>
                          <a href="#" class="btn btn-info text-white mb-3" data-toggle="modal" data-target=".filter_job">
                      ...
                      <table class="table table-striped normal-table" id="table1">
                        ...
                        <tbody>
                          <tr>
                            ...
                            <td>
                              <a href="" data-toggle="modal" data-target=".add_job_main_category" class="bg-primary action-icon text-white btn-primary"><i class="fas fa-pencil-alt"></i></a>
...
<div class="modal fade add_job_main_category" tabindex="-1" role="dialog" aria-labelledby="add_job_main_category"
    aria-hidden="true">
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title text-dark" id="add_job_main_category">Add Category</h5>
