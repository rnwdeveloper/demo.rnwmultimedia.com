          ...
          <div class="extra_Block_box">
            ...
            <div class="extra_lead_menu d-inline-block w-100 position-relative">
              ...
              <ul>
                ...
                <?php echo  $k; ?> (<?php echo $v; ?>)</a></li>

                <?php } ?>

                <!-- <li><a href="#" class="active">All (4)</a></li>

                <li><a href="#">Enroll (466)</a></li>

                <li><a href="#">My Student (33)</a></li>

                <li><a href="#">Hold(77)</a></li>

                <li><a href="#">Completed (0)</a></li>

                <li><a href="#">Terminated (3)</a></li>

                <li><a href="#">Cancelled (0)</a></li>

                <li><a href="#">Alumni (0)</a></li> -->  
                    ...
                    <li>
                      ...
                      <li>
                        ...
                        <li>
                          ...
                          <a href="https://api.whatsapp.com/send?phone=91<?php echo $adm->mobile_no; ?>" target="_blank" title="Sent Whatsapp Message"><i class="fab fa-whatsapp"></i></a>
      ...
      <div class="row">
        ...
        <div class="col-xl-12">
          ...
          <div class="modal-header px-0">
            ...
            <h5 class="modal-title"><span id="change_adm_status">Admission Edit</span>&nbsp;<span id="stu_name"></span><p class="flip btn btn-sm btn-success show_btn" onclick="myFunction()">Edit</p> <button type="button" class="btn btn-sm btn-success edit_btn" id="update_adm_details">Update</button> <p class="flip btn btn-sm btn-success show_upd_course" onclick="course_upd_function()">Edit</p> <button type="button" class="btn btn-sm btn-success edit_course_btn"  id="upd_course">Update</button></h5>
	              	...
	              	<form method="post" id="admission_sms_template"  style="position: relative;">
		          		...
		          		<div class="sms_template_view" style="padding:0.4rem 0.4rem 0.4rem 0.4rem">
				            ...
				            <div class="form-group" id="send_email_button_show">
				            	...
				            	<input type="button" id="send_email_template_button" onclick="return send_sms_data();" name="submit" value="Submit" class="submit-btn" style="top:100%; right: 8%;">
...
<div class="filter_ratio" id="filter_ratio">
  ...
  <div class="modal fade" id="withoutcourse_fees_modal">

    <div class="modal-dialog modal-dialog-centered modal-lg" role="document" style="max-width: 800px;">

      <div class="modal-content" id="get_withoutcourse_fees_data">
...
<div class="filter_ratio" id="filter_ratio">
  ...
  <div class="modal fade" id="instalmet_unpaid">

    <div class="modal-dialog modal-dialog-centered modal-lg" role="document" style="max-width: 600px;">

      <div class="modal-content" id="payment_instalment">
...
function student_detail_record(admission_id='')
{
  ...
  function unpaid_payment(admission_installment_id=''){
...
function upgarede_course_without_fees_modification(admission_id='')
{

  $('#withoutcourse_fees_modal').modal('show');

  $.ajax({

    url : "<?php echo base_url(); ?>AddmissionController/upgarede_course_without_fees_modification",
...

    {
      ...
      $('#get_withoutcourse_fees_data').html(Response);
...

   {
    ...
    var data = $.parseJSON(res);
       ...
       //console.log(data);
        ...
        var admidupdcoursewithoutfees = data.record['adm_get_record'].admission_id;

        var admidupdcoursewithoutfeesIds  = "withoutfees_updadm_id"+fornumberData;

        $('#'+admidupdcoursewithoutfeesIds).html('<a href="#" class="dropdown-item"  onclick="return upgarede_course_without_fees_modification('+admidupdcoursewithoutfees+')"><i class="fas fa-pen-square" ></i>Upgrade course</a>');
       ...
       var enroll = data.record['adm_get_record'].enrollment_number;

        var enrolldata  = "enrollmentno_data"+fornumberData;

        $('#'+enrolldata).html(enroll);
   }
