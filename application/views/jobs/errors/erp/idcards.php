...
<body>
	...
	<div id="id_card">
		...
		<div class="logo_container">		
			...
			<img src="http://demo.rnwmultimedia.com/New_Demo_Soft/images/logo_White.png" alt="logo" class="logo">
		...
		<div class="student_detail">
			...
			<span style="font-size: 12px; font-weight: 500;"><b><?php echo $admission->surname; ?> <?php echo $admission->first_name; ?></b></span>
			...
			<span><?php echo  "<b>Admission Date: </b>".''. $admission->admission_date; ?></span>
