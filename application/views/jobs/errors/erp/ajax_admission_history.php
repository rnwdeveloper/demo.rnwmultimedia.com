...
<?php foreach($history_without_fees as $h) { ?>
<span style='color:black'><b>Without Fees Modification Course</b></span><br>
<p><span style="color:gray">Update Date:</span>
...
<p><span style="color:gray">SubDepartment:</span>

		<?php 

		 $br = explode('&#',$h->subdepartment_id); 

	     if($br[1]=='nochange') {  ?>

	     	<span style='color:black'><b>

	     		<?php foreach($list_subdepartment as $lb) { 

	     				if($lb->subdepartment_id == $br[0])

	     				{ 

	     					echo $lb->subdepartment_name; 
