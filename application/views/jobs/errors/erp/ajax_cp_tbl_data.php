  ...
  font-size: 12px;
                  ...
                  <li class="d-inline-block mr-3 mr-mr-0">
                              <div class="form-check form-check-inline">
                                  <input class="form-check-input" type="radio" id="type" name="type" value="package" <?php if(@$adm_get_record->type=="package") { echo "checked"; } ?> onclick="return show_hide_package_course()" />Package
                              </div>
                              <div class="form-check form-check-inline">
                                  <input class="form-check-input" type="radio" id="type" name="type"  value="single" <?php if(@$adm_get_record->type=="single") { echo "checked"; } ?> onclick="return show_hide_package_course()"/>Single
                              </div>
                          </li>
                      </ul>
  ...
  <div class="modal-dialog" role="document" style="top: 70px;">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Course Completed</h5>
...
<div class="modal fade" id="adm_completed" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document" style="top: 70px;">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Admission Completed</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
...
$.ajax({
    ...
    alert('Are You Sure This Course As Completed');
    }
});
return false;
});
...
$.ajax({
    ...
    alert('Are You Sure This Admission As Completed');
    }
});
return false;
});
...
<script type="text/javascript">
      $('#upd_course').on('click',function(){
            ...
            $.ajax({
                ...
                dataType : "JSON",
                data : {'admission_id' : upd_id ,  'branch_ids' : branch_ids ,'type' : type ,  'package_id' : course_orpackage , 'course_id' : course_orsingle , 'faculty_id' : faculty_id , 'batch_id' : batch_id },
                success: function(data){
