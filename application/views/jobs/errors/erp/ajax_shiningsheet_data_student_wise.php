  ...
  <tr>
    ...
    <td colspan="6"><b>COURSE NAME : </b><?php echo $match_course->course_name; ?></td>
    <td colspan="3"><b>TOTAL DAYS : </b> <input type="text" size="8" class="form" name="total_days" id="total_days" value="">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
       ...
       <td></td>
      <td>
        <a  onclick="return assigned_multistudent(<?php echo $val->shining_sheet_id;?>,<?php echo $fetch_betch->batches_id;?>)" title="Assign Student Mail"><i class="fa fa-tasks" style="font-size:20px;color:#0b527e;"></i></a>
      </td>
    </tr>
    <?php $i++; } ?>
  </tbody>
