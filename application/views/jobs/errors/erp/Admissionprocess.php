		...
		<div class="container-fluid">
								...
								<div class="form-row" style="margin-top: -18px;">
									...
									<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 select_course_single" >
										...
										<div class="form-group">
										 ...
										 <select class="select2 form-control custom-form-control course_or_single" name="course_or_single[]" id="course_orsingle" multiple="multiple">
									...
									<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 align-self-end">
										...
										<div class="form-group float-right">
											...
											<input type="submit" name="submit" value="Receipt Gst" id="Receiptgst" class="btn-sm btn-primary">
	        ...
	        <ul class="list-group text-center">
	          ...
	          <li class="list-group-item">
	           ...
	           <span style="color: red"><div id="gr_ids"></div></span>

	           <span style="color: red"><div id="enrollmentno"></div></span>

	           <span style="color: red"><div id="admissionbarnch"></div></span>

	           <span style="color: red"><div id="fullname"></div></span>

	           <span style="color: red"><div id="admission_mobileno"></div></span>

	           <span style="color: red"><div id="admission_course"></div></span>

	           <span style="color: red"><div id="af"></div></span>

	           <span style="color: red"><div id="admission_date"></div></span>

	           <span style="color: red"><div id="admission_adby"></div></span>
	          ...
	          <span style="color: red"><div id="demo_idss"></div></span>

	          <span style="color: red"><div id="branch"></div></span>

	          <span style="color: red"><div id="name"></div></span>

	          <span style="color: red"><div id="demomobileno"></div></span>

	          <span style="color: red"><div id="startingCourse"></div></span>

	          <!-- <span style="color: red"><div id="faculty_demo"></div></span> -->

	          <span style="color: red"><div id="demodate"></div></span>

	          <span style="color: red"><div id="addedby"></div></span>
	          ...
	          <li class="list-group-item">
	           ...
	           <span style="color: red"><div id="lead_list_idss"></div></span>

	           <span style="color: red"><div id="lead_branch"></div></span>

	           <span style="color: red"><div id="lead_name"></div></span>

	           <span style="color: red"><div id="leadmobile_no"></div></span>

	           <span style="color: red"><div id="lead_course"></div></span>

	           <span style="color: red"><div id="lead_creation_date"></div></span>

	           <span style="color: red"><div id="reference_name"></div></span>
