  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li ><a href="<?php echo base_url(); ?>Enquiry/inquirys">Enquiry List</a></li>
        <li class="active"><a href="<?php echo base_url(); ?>Enquiry/trashedInquirys">Trashed Enquiry List</a></li>
  ...
  <div class="modal fade" id="myModal_filter" role="dialog">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <form method="post" action="<?php  echo base_url(); ?>Enquiry/trashedInquirys">
          ...
          <a class="btn btn-primary" href="<?php echo base_url(); ?>Enquiry/inquirys">Reset</a>
            ...
            <div  id="enq_table">  
              <table  class="table table-bordered table-striped example1">
                ...
                <tbody>
            <?php $sno=1; foreach($all_inquiry as $val) { if($val->enquiry_trash=="1") { ?>    
                <tr>
                  <td>
                 ...
                 <?php if(!empty($val->enquiry_follwup_interestLevel)) { echo $val->enquiry_follwup_interestLevel; } ?>
                  ...
                  <td>
                        <?php if(!empty($val->enquiry_cancel_reason)) { echo $val->enquiry_cancel_reason."<br>"; }  ?>
                        <?php if(!empty($val->enquiry_trashed_reason)) { echo $val->enquiry_trashed_reason; }  ?>
                      
                  </td>
                  <td>
                      <?php if(!empty($val->enquiry_trashed_by)) { echo $val->enquiry_trashed_by; }  ?>
                    </td>
                  ...
                  <td>
                  	 ...
                  	 <div class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li ><a href="<?php echo base_url(); ?>Enquiry/move_to_enq/<?php echo $val->enquiry_id; ?>">Move to Enquiry List</a></li>
