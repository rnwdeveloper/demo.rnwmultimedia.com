      ...
      <div class="section-body">
         <div class="row">
            <div class="col-12 d-flex justify-content-between">
               <h6 class="page-title text-dark mb-3">Lead Followup status</h6>
               ...
               <div class="card">
                  <div class="card-header d-flex justify-content-between income-wrapper">
                     <div class="table-right-content text-right w-100">
                        <button class="btn btn-info"  data-toggle="modal" data-target=".create-lead" onclick="resetval()"><span data-toggle="tooltip" data-placement="bottom" title="Create Lead Status"><i class="fa fa-plus"></i></span></button>  
                     </div>
                  </div>
                  <div class="card-body">
                     <div class="table-responsive">
                        <table class="table table-striped income-table" id="table1">
                           ...
                           <tbody>                              
                           <?php $sno=1; foreach($status_list as $cl) { ?>
                              <tr>
                                 <td><?php echo $sno; ?></td>
                                 <td>
                                 <?php echo $cl->followup_type_name; ?>                     
                                 </td>
                                 <td>
                                 <?php echo $cl->addBy; ?>
                                 </td>
...
<div class="modal fade create-lead" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel"
      aria-hidden="true">
      <div class="modal-dialog modal-sm">
      <div class="modal-content">
         <div class="modal-header">
            <h5 class="modal-title" id="mySmallModalLabel">Create Followup Lead Status</h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
            </button>
         </div>
         <div class="modal-body">
         <form enctype="multipart/form-data" class="document-createmodal" method="post" name="leadstatus_add" id="leadstatus_add">
         <input type="hidden" name="followup_type_id" id="followup_type_id" class="form-control">
         <div class="form-row">
            <div class="form-group col-md-12">
               <label for="inputEmail4">Add Followup Status:</label>
               <input class="form-control" type="text" name="followup_type_name" id="followup_type_name" placeholder="Enter School-College Name" required value="">
            </div>
         </div>
         <div class="form-row">
         <div class="form-group col-md-12">
   ...
   <script>
      $("#leadstatus_add").validate({
        ...
        submitHandler: function() {
          ...
          var form = $('#leadstatus_add')[0];
          var data = new FormData(form);

          $.ajax({
            type: "POST",
            enctype: 'multipart/form-data',
            url: "<?php echo base_url(); ?>LeadlistController/ajax_leadstatus",
            type: "post",
            data: data,
            processData: false,
            contentType: false,
      ...
      function upd(followup_type_id) {
        $.ajax({
          url: "<?php echo base_url(); ?>LeadlistController/get_record_leadstatus",
          type: "post",
          data: {
          ...
          success: function(resp) {
            ...
            var followup_type_id = data['single_record'].followup_type_id;
            var followup_type_name	 = data['single_record'].followup_type_name;
         
            $('#followup_type_id').val(followup_type_id);
            $('#followup_type_name').val(followup_type_name);
      ...
      function status_upd(followup_type_id, status) {
        $.ajax({
          ...
          data: {
            'id': followup_type_id,
            'status': status,
            'table': 'bulk_lead_followup_type',
            'field': 'lead_status',
            'check_field': 'followup_type_id'
          },
          success: function(resp) {
            var data = $.parseJSON(resp);
      ...
      function remove(followup_type_id) {
