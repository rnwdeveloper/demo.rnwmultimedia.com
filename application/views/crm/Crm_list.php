...
<div class="main-content overflow-hidden">
   ...
   <div class="extra_lead_menu" id="response_sidemail_compose">
      <div class="extra_top-menu lead-list-menu">
        <div class="lead-list-right-menu mt-2 mb-2">
          <div class="lead-list-icon text-right">
            ...
            <a href="#" class="btn btn-info text-white mb-3" data-toggle="modal" data-target=".quick-lead"><i class="fa fa-plus"></i></a>
            <a href="#" class="btn btn-info text-white mb-3"><i class="fa fa-bullhorn"></i></a>
            <a href="#" class="btn btn-info text-white open_rightsidebar mb-3" onclick="return referleads()"><i class="fas fa-share-alt-square"></i></a>
            <a href="#" class="btn btn-info text-white open_rightsidebar mb-3" onclick="return leaduser_wisesms_endfilteredsms()"><i class="fa fa-comment-alt"></i></a>
            <a href="#" class="btn btn-info text-white open_rightsidebar mb-3" onclick="return leaduser_wise_endfiltered()"><i class="fa fa-envelope"></i></a>
            <a href="#" class="btn btn-info text-white mb-3" data-toggle="modal" data-target=".downloadlead"><i class="fa fa-download"></i></a>
            <a href="#" class="btn btn-info text-white open_rightsidebar mb-3" onclick="return filterlead()"><i class="fa fa-filter"></i></a> 
            <div class="dropdown d-inline-block align-middle dropleft mb-3">
        ...
        <ul class="active_tab w-100 pl-0">
      ...
      <div class="sidebar-panel pullDown"> 
       ...
       <div class="rsidebar-items send-mail send-email-details">
               ...
               <div class="rsidebar-middle">
                   ...
                   <div class="rs-btn">
                      <div class="form-fix-bottompb-4 mb-4">
                       ...
                       <input type="submit" class="btn btn-primary text-white" id="send_email_forstudent"
                           name="submit" value="Submit" onclick="return send_email_data();"></div>
                   </div>
               </div>
           </div>

              <div class="rsidebar-items send-email-details-correntuser-filtered">
                 <div class="rsidebar-title">
                   <h3 class="mb-0">Send Email To :- (<span class="countedltwo"></span><span class="userwise"><?php echo @$user_wise_lead_count; ?></span>)</h3>
               </div>
                <input type="hidden" class="form-control referid_email" id="refer_to_lead_id_for_email">
                <input type="hidden" class="form-control" value="<?php echo @$user_wise_lead; ?>" id="user_wise_lead_id_for_email">
               <div class="rsidebar-middle">
                   <div class="pretty p-default p-round p-thick">
                       <input type="checkbox" name="email_id_send" id="primary_email_two" value="<?php echo "primary"; ?>" checked>
                       <div class="state p-primary-o">
                           <label>Primary Email</label>
                       </div>
                   </div>
                   <div class="pretty p-default p-round p-thick">
                       <input type="checkbox" name="father_email" id="father_email_two">
                       <div class="state p-primary-o">
                           <label>Father's Email</label>
                       </div>
                   </div>
                   <div class="pretty p-default p-round p-thick">
                       <input type="checkbox" name="email_id_send" id="guardian_email_two">
                       <div class="state p-primary-o">
                           <label>Guardian's Email</label>
                       </div>
                   </div>
                   <div class="pretty p-default p-round p-thick">
                       <input type="checkbox" name="father_email" class="" id="alternate_email_two">
                       <div class="state p-primary-o">
                           <label>Alternate Email</label>
                       </div>
                   </div>
                   ...
                   <div class="form-group">
                       <select class="form-control email-template-to" id="email_templatetwo" onchange="return get_email_templatetwo();">
                           <option value="">Select Email Template</option>
                           <?php foreach ($list_email_template as $lt) { ?>
                           <option value="<?php echo $lt->id; ?>"><?php echo $lt->category; ?></option>
                           <?php } ?>
                   ...
                   <div class="form-group">
                       <label>Subject*</label>
                       <textarea class="form-control email-subject-to" name="email_subject" id="email_subjecttwo" rows="8"></textarea>
                   </div>
                   <div class="text-right">
                   <button class="btn btn-white compose-btn" data-toggle="modal"
                    data-target=".bd-example-modal-lg"><i class="fa fa-plus text-primary"></i> Compose</button>
                   ...
                   <div class="rs-btn">
                     <div class="form-fix-bottompb-4 mb-4">
                       <a href="" class="btn btn-danger text-white">Cancel</a>
                       <input type="submit" class="btn btn-primary text-white" name="submit" value="Submit" onclick="return send_user_wise_mail_end_all()">
                           </div>
                   </div>
               </div>
           </div>
         ...
         <div class="rsidebar-items send-sms send-sms-details">
          ...
          <div class="rsidebar-items send-sms send-sms-details-filtred-leadwise">
            <div class="rsidebar-title">
               <h3 class="mb-0">Send Sms To : (<span class="countedlthree"></span><span class="userwisethree"><?php echo @$user_wise_lead_count; ?></span>)</h3>
            </div>
            <div class="rsidebar-middle">
               <div id="sms_send_msg"></div>
                <input type="hidden" class="form-control referid_sms" id="refer_to_lead_id_for_sms">
                <input type="hidden" class="form-control" value="<?php echo @$user_wise_lead; ?>" id="user_wise_lead_id_for_sms">
                    <div class="pretty p-default p-round p-thick">
                  <input type="checkbox" name="primary_sms" id="primary_sms_two" value="<?php echo "primary"; ?>" checked>
                  <div class="state p-primary-o">
                     <label>Primary Sms</label>
                  </div>
               </div>
               <div class="pretty p-default p-round p-thick">
                  <input type="checkbox" name="father_sms" id="father_sms_two">
                  <div class="state p-primary-o">
                     <label>Father's Sms</label>
                  </div>
               </div>
               <div class="pretty p-default p-round p-thick">
                  <input type="checkbox" name="guardian_sms" id="guardian_sms_two">
                  <div class="state p-primary-o">
                     <label>Guardian's Sms</label>
                  </div>
               </div>
               <div class="pretty p-default p-round p-thick">
                  <input type="checkbox" name="alernate_sms" class="" id="alternate_sms_two">
                  <div class="state p-primary-o">
                     <label>Alternate Sms</label>
                  </div>
               </div>
               ...
               <div class="form-group">
                  <select class="form-control" name="sms_template" id="sms_template_two"
                     onchange="return get_sms_template_two();">
                     <option value="">Select SMS Template</option>
                        <?php foreach($sms_template_list as $lt) { ?>
                        <option value="<?php echo $lt->category; ?>"><?php echo $lt->category; ?></option>
                        <?php } ?> 
               ...
               <div class="form-group">
                  <label>SMS Template</label>
                  <textarea class="form-control sms-compose-detail" id="sms_compose_Textarea_two" name="sms_compose_Textarea" rows="8"></textarea>
               </div>
               <div class="rs-btn">
                  <div class="form-fix-bottom pb-4 mb-2">
                  <a href="#" class="btn btn-danger text-white">Cancel</a>
                  <input type="submit" class="btn btn-primary text-white all_endfiltered" id="send_sms_student" value="Submit">
                        </div>
               </div>
            </div>
         </div>
                           ...
                           <div class="col-md-12">
                              <div class="form-fix-bottom">
                                 <div class="mb-3" role="group" aria-label="Basic example">
                                    <a class="btn btn-danger text-white" href="<?php echo base_url(); ?>LeadlistController/crm_list">Cancel</a>
                                    <a type="button" class="btn btn-success text-white" onclick="return lead_refertto()">Refer</a>
                                 </div>
                              </div>
                           </div>
                        </div>
                     ...
                     <div class="col-md-12">
                        ...
                        <div class="col-xl-12 col-lg-12">
                           <div class="form-group" id="select_course_package_quicks">
                              <label>Course</label>
                              <select class="form-control" id="filter_courses" name="filter_courses">
                              <option value="">Select Package</option>
                                 <?php foreach($list_package as $lp) { ?>
                                 <option value="<?php echo $lp->package_id; ?>"><?php echo $lp->package_name; ?></option>
                                 <?php } ?>
                        ...
                        <div class="col-xl-12 col-lg-12">
                           <div class="form-group">
                              <label>To Next Action Date</label>
...
<div class="lead_upload-data btn-primary open_rightsidebar" onclick="return newlead_add()"> 
...
var picker = new Lightpick({
    field: document.getElementById('next_followup_date2'),
...
function filtering_lead()
{
   ...
   var filter_courses = $('#filter_courses').val();
   ...
   var filter_to_creatioon_date = $('#filter_to_creatioon_date').val();
      ...
      $.ajax({
         ...
         success: function(repo) {
            ...
            $('#refer_to_lead_id_for_email').val(data);
            $('#refer_to_lead_id_for_sms').val(data);
            $('.countedl').html(count);
            $('.countedltwo').html(count);
            $('.countedlthree').html(count);
            $('.userwise').hide();
            $('.userwisetwo').hide();
            $('.userwisethree').hide();
...
function send_user_wise_mail_end_all(){
   var user_wise_lead_ids = $('#user_wise_lead_id_for_email').val();
   var lead_list_ids = $('.referid_email').val();
   var primary_email = $('.primary_email_two').val();
   var email_template= $('.email-template-to').val();
   var email_subject = $('.email-subject-to').val();
  
      $.ajax({
         url: "<?php echo base_url(); ?>LeadlistController/send_email_filtered_end_userwise",
         type: "post",
         data: {
            'user_wise_lead_ids': user_wise_lead_ids,
            'lead_list_ids': lead_list_ids,
         ...
         success: function(resp) {
            ...
            if(ddd=='1'){
               $('#msg').html(iziToast.success({
                  title: 'Success',
                  timeout: 2500,
                  message: 'SuccessFully Send Mail Filtered Lead.',
                  position: 'topRight'
                  }));
               ...
               $('#msg').html(iziToast.error({
                  title: 'Success',
                  timeout: 2500,
                  message: 'SuccessFully Send Mail Current User Lead',
                  position: 'topRight'
                  }));
...
function add_followup_lead_list(lead_list_id)
{
   $.ajax({
      ...
      success: function(res)
      {
         ...
         $('#school_college_id').val(data.record['lead_get_record'].school_college_id);
         $('#followup_mode').val(data.record['lead_get_record'].followup_mode);
         $('.next-followup-mode').val(data.record['lead_get_record'].next_followup_date);
...
function show_email_template(lead_id){
   ...
   function get_email_templatetwo()
   {
    var id =  $('#email_templatetwo').val();
    ...
    $.ajax({
      ...
      success:function(res){
          var data = $.parseJSON(res);
          $('#email_subjecttwo').val(data.reco['record'].category);
          $('#send_email_template_button').prop('disabled', false);
          // $('#email_compose_Textarea').val("123");
          var content_data =  data.reco['record'].html_template;
          var title_data = $('textarea[name=email_compose_Textarea]').html(content_data).text();
   ...
   function get_sms_template_two(){
      var sms_template_id =  $('#sms_template_two').val();
      ...
      $.ajax({
         ...
         success:function(response){
               var data = $.parseJSON(response);
               $('#sms_compose_Textarea_two').val(data.reco['records'].sms_template);
         }
      });
   }
   ...
   function filterlead(id)
   {
    ...
    function leaduser_wise_endfiltered(id)
   {
      $('.edit-details').hide();
      $('.first-section').hide();
      $('.second-section').hide();
      ...
      $('.crm-followup_record').hide();
      $('.crm-demo').hide();
      $('.send-email-details-correntuser-filtered').show();
      $('.send-sms-details-filtred-leadwise').hide();
   }

   function leaduser_wisesms_endfilteredsms(id)
   {
      $('.edit-details').hide();
      $('.first-section').hide();
      $('.second-section').hide();
      ...
      $('.crm-demo').hide();
      $('.send-email-details-correntuser-filtered').hide();
      $('.send-sms-details-filtred-leadwise').show();
   }
   
   function newlead_add(id){
      $('.edit-details').show();
      $('.first-section').show();
      $('.second-section').show();
      $('.third-section').show();
   ...
   $('#select_course_package').hide();
   function get_course_package(package){
   	if(package == 'package'){
   		$('#select_course_package').show();
   		$('#select_course_single').hide();
   	}else{
...
<script>  
  $('.all_endfiltered').on('click', function() {
   var user_wise_lead_ids = $('#user_wise_lead_id_for_sms').val();
   var lead_list_ids = $('.referid_sms').val();
   var primary_sms = $('#primary_sms_two').val();
   var sms_template = $('#sms_template_two').val();
   var sms_compose_Textarea = $('#sms_compose_Textarea_two').val();

    $.ajax({
      type: "POST",
      url: "<?php echo base_url() ?>LeadlistController/send_sms_filtered_end_userwise",
      data: {
         'user_wise_lead_ids': user_wise_lead_ids,
         'lead_list_ids': lead_list_ids,
         'primary_sms': primary_sms,
         'sms_template': sms_template,
         'sms_compose_Textarea': sms_compose_Textarea
      },
      success: function(resp) {
         var data = $.parseJSON(resp);
         var ddd = data['all_record'].status;
         if(ddd=='1'){
            $('#msg').html(iziToast.success({
               title: 'Success',
               timeout: 2500,
               message: 'SuccessFully Send SMS Filtered Lead.',
               position: 'topRight'
               }));
            ...
            $('#msg').html(iziToast.error({
               title: 'Success',
               timeout: 2500,
               message: 'SuccessFully Send SMS Current User Lead',
               position: 'topRight'
               }));
