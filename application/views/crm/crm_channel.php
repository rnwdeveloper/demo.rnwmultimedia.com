      ...
      <div class="section-body">
         <div class="row">
            <div class="col-12 d-flex justify-content-between">
               <h6 class="page-title text-dark mb-3">Channel</h6>
               ...
               <div class="card">
                  <div class="card-header d-flex justify-content-between income-wrapper">
                     <div class="table-right-content text-right w-100">
                        <button class="btn btn-info"  data-toggle="modal" data-target=".create-channle" onclick="resetval()"><span data-toggle="tooltip" data-placement="bottom" title="Add Channel"><i class="fa fa-plus"></i></span></button>  
                     </div>
                  </div>
                  <div class="card-body">
                     <div class="table-responsive">
                        <table class="table table-striped income-table" id="table1">
                           ...
                           <tbody>
                              <?php $sno=1; foreach($channel_list as $cl) { ?>
                              <tr>
                                 <td><?php echo $sno; ?></td>
                                 <td>
                                 <?php echo $cl->channel_name; ?>                     
                                 </td>
                                 <td>
                                 <?php echo $cl->addBy; ?>
                                 </td>
...
<div class="modal fade create-channle" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel"
          ...
          <div class="modal-dialog modal-sm">
            <div class="modal-content">
              ...
              <form enctype="multipart/form-data" class="document-createmodal" method="post" name="channel_add" id="channel_add">
              <input type="hidden" name="channel_id" id="channel_id" class="form-control">
               <div class="form-row">
                  <div class="form-group col-md-12">
                     <label for="inputEmail4">Channel Name:</label>
                     <input class="form-control" type="text" name="channel_name" id="channel_name" placeholder="Enter channel Name" required value="">
                  </div>
               </div>
               <div class="form-row">
               <div class="form-group col-md-12">
...
<script>
      $("#channel_add").validate({
        ...
        submitHandler: function() {
          ...
          var form = $('#channel_add')[0];
          var data = new FormData(form);

          $.ajax({
            type: "POST",
            enctype: 'multipart/form-data',
            url: "<?php echo base_url(); ?>LeadlistController/ajax_channel",
            type: "post",
            data: data,
            processData: false,
            contentType: false,
      ...
      function upd(channel_id) {
        $.ajax({
          url: "<?php echo base_url(); ?>LeadlistController/get_record_channel",
          type: "post",
          data: {
          ...
          success: function(resp) {
            ...
            var channel_id = data['single_record'].channel_id;
            var channel_name	 = data['single_record'].channel_name;
      ...
      function status_upd(channel_id, status) {
        $.ajax({
