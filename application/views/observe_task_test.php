                ...
                <table class="table table-striped" style="font-size: 12px;">
                  <tbody class="text-center">
                    ...
                    <?php
                        ...
                        // print_r($assign_task);
                        // die;
                        foreach ($assign_task as $w => $value) 
                        {
                          foreach ($member as $rohan => $mohan) 
                          {
                            if($mohan->member_id == $value->task_observe_member_id)
                            {
                              if($mohan->member_account_id == $_SESSION['user_id'])
                                { ?>
                                <tr>                    
                                  <td>
                                    <?php 
                                  ...
                                  <td>
                                    <?php echo date("d-m-Y",strtotime($value->task_dedline_date)); ?> <?php echo $value->task_dedline_time; ?>  
                                  </td>
                                  <td>
                                    <?php
                                  ...
                                  <td>
                                    <div class="badge badge-success p-2"><?php echo $value->task_priority; ?></div>
                                  </td>
                                  <td>
                                    <a href="#" class="text-info" data-toggle="modal" data-target="#ss<?php echo $w; ?>">
                                      <i class="fas fa-eye" data-toggle="tooltip" data-placement="left" title="Show Task Details"></i>
                                    </a>
                                    <div class="filter_ratio filter_ratio_one">
                                      <div class="modal fade task-model" id="ss<?php echo $w; ?>" style="font-size: 12px;">
                                                  ...
                                                  <td>
                                                    <?php 
                                                      if($q->task_observe_status == 0) { ?>
                                                        <div><button type="button" class="btn-sm btn-danger">Unsubmit</button></div>
                                                        ...
                                                        <?php foreach ($task_resubmit as $e => $f) {
                                                          if($f->task_submit_id == $q->task_submit_id)
                                                          {
                                                            if($f->status == 1)
                                                            { ?>
                                                            <button type="button" class="btn-sm btn-success" data-toggle="modal" data-target="#m<?php echo $w; ?>">ReSubmit</button>
                                                                ...
                                                                <div class="modal-content">
                                                                  ...
                                                                  <div class="modal-body">
                                                                    ...
                                                                    <form method="post" action="<?php echo base_url(); ?>TaskController/upd_re_observe_comment">
                                                                      ...
                                                                      Observe Ans:
                                                                      <input type="radio" name="ob" value="2" onclick="task_resubmit(this.value,<?php  echo $f->task_resubmit_id; ?>)">Done
                                                                      <input type="radio" name="ob" value="3" onclick="task_resubmit(this.value,<?php  echo $f->task_resubmit_id; ?>)">Resubmit
                                                                      <div id="show_date_time_<?php  echo $f->task_resubmit_id; ?>"></div>
                                                                      <div class="form-group">
                                                                        <textarea name="name" class="form-control"></textarea>
                                                                      </div>
                                                                      <button type="submit" value="submit" class="btn-sm btn-success">submit</button>
                                                                    </form>
                                                                  </div>
                                                            ...
                                                            <?php  }else if($f->status == 3){?>
                                                              <button type="button" class="btn-sm btn-warning" data-toggle="modal" data-target="#m<?php echo $w; ?>">
                                                                ReSubmit
                                                              </button>
                                                              <div class="modal fade" id="m<?php echo $w; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                                                <div class="modal-dialog modal-dialog-centered" role="document">
                                                            ...
                                                            <?php } } } ?>
                                                            <?php }else if($q->task_observe_status == 2){ ?> Done <?php }else{ ?>
                                                            <button type="button" class="btn-sm btn-success" data-toggle="modal" data-target="#m123<?php echo $w; ?>">Submit</button>
                                                            <!-- Modal -->
                                                                    ...
                                                                    <h5 class="modal-title" id="exampleModalLongTitle">
                                                                      ...
                                                                      <?php 
                                                                        if($q->task_submit_date!= "")
                                                                        {
                                                                          ...
                                                                          else if(date("d-m-Y",strtotime($q->task_submit_date)) < date("d-m-Y",strtotime($value->task_dedline_date)))
                                                                          {
                                                                            echo "Very Good";
                                                                          }
                                                                          else
...
<script type="text/javascript">
  $(document).ready(function(){
    $('.task').focus(function(){
      $('#task').html('data-toggle="tooltip" data-placement="left" title="Show Task Details"');
      //$("").css("display", "inline").fadeOut(2000);
    });
  });
</script>
