...
<main class="main_content d-inline-block">
	...
	<div class="new_lead_genered_btn">
		<a href="javascript:void(0)" class="create_new_lead"><i class="fas fa-plus" style="line-height: 60px;"></i></a>
	</div>
			...
			<div class="row">
				<div class="col-xl-12">
					<div class="modal-header px-0">
						<h5 class="modal-title">Filter Chart</h5>
						...
						<div class="right_side_row_panel">
							...
							<div class="right_side_row_panel_block collapse show" id="candidate_details" data-parent="#create_leade">
								<div class="new_lead_info_fill">
									...
									<div class="form-group">
										<h5><b>Admin</b></h5>
										<?php foreach ($admin_all as $key => $value) { ?>
										<div><?php echo $value->name; ?><input type="checkbox" name="admin_id[]" value="<?php echo $value->user_id; ?>" onclick="admin(<?php echo $value->user_id; ?>);"></div>
										<?php } ?>
									</div>
									...
									<div class="form-group">
										...
										<!-- <?php foreach ($branch_all as $key => $value) { ?>
										<div><?php echo $value->branch_name; ?><input type="checkbox" name=""></div>
										<?php } ?> -->
									</div>
									...
									<div class="form-group">
										...
										<!-- <?php foreach ($department_all as $key => $value) { ?>
										<div><?php echo $value->department_name; ?><input type="checkbox" name=""></div>
										<?php } ?> -->
									</div>
...
<script type="text/javascript">
 	function admin(id)
 	{
 	 ...
 	 $.ajax({
        ...
        url:"<?php echo base_url(); ?>ChartController/admin_all",
...
$(function() {
   ...
   var start1=moment().subtract(1, 'days');
    ...
    function cb(start, end) {
        ...
        $.ajax({
           url:'<?php echo base_url(); ?>ChartController/all_demo_serach',
           type:"post",
           data:{'d':start.format('DD-MM-YYYY') ,'e': end.format('DD-MM-YYYY'),'abc':$('#filterForm').serialize()},
           success: function(data)
              {
