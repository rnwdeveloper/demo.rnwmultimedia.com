        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary" style="padding:20px;">
            <div class="box-header with-border">
              <h3 class="box-title"><b>Display Assign Lead All Data</b></h3>
              <br><br>
          ...
          <a class="btn btn-primary" href="<?php echo base_url(); ?>Bulk_LeadController/Bulk_lead">Reset</a>
            ...
            <!-- /.box-header -->
              ...
              <table id="example1" class="table table-responsive table-bordered table-striped example1">
                ...
                <?php $sno=1; foreach($all_assignData as $val) { ?>
                <tr>
                  <td>
                       <?php echo $num++ ?>
                    </td>
                  <td><?php if(!empty($val->name)) { echo $val->name."<br>"; } else { echo "Name Not Available <br>"; } ?>
                  <?php if(!empty($val->email)) { echo $val->email."<br>"; } else { echo "Email Not Available <br>"; } ?>
                 ...
                 <?php } ?>
                  ...
                  <a href="https://api.whatsapp.com/send?phone=0123456789&text=I'm%20interested%20in%20your%20services" target="https:whatsapp.com">
                  <i class="fa fa-whatsapp" style="font-size:20px;color: green;margin-left: 10px;"></i></a>
                  <a href="tel:123-456-7890"><i class="fa fa-phone" style="font-size: 20px;color: green;margin-left: 10px;"></i></a>
                    </td>
                  ...
                  <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                      <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                        <h4 class="modal-title"><b>Assigned All data</b></h4>
                      </div>
                      <div class="modal-body">
                      ...
                      <div class="table-responsive">  
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <?php echo $val->priority; ?></td>
                             <td><?php echo $val->address ; ?></td>
                             <td><?php echo $val->assign_date; ?></td>
                            <td><?php echo $val->other_remark; ?></td>
                            <!-- Modal -->
