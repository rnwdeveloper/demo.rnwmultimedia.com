                      ...
                      foreach ($branch_all as $val) { ?>
                        <tr>
                          ...
                          <td>
                            ...
                            <strong>Email :</strong> <span><?php echo $val->branch_email; ?></span> </br>
            ...
            <div class="card">
              <div class="branch-items row mb-2">
                ...
                <div class="form-group col-md-4 col-sm-12">
                  ...
                  <input class="form-control" id="branch_email" type="text" name="branch_email" placeholder="Enter Email ID" required>
                </div>
                <div class="form-group col-md-4 col-sm-12">
      ...
      function doc_upd(branch_id) {
        ...
        $.ajax({
          ...
          success: function(resp) {
            ...
            var branch_email = data['single_record'].branch_email;
