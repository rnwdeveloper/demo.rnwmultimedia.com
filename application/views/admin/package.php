...
<div class="main-wrapper main-wrapper-1">
      ...
      <div class="section-body">
        <div class="row">
          <div class="col-12 d-flex justify-content-between">
            <h6 class="page-title text-dark mb-3">Package</h6>
            ...
            <div class="card">
              <div class="card-header d-flex justify-content-between income-wrapper">
                ...
                <div class="table-right-content">
                  <button href="#" class="btn btn-info" data-toggle="modal" data-target="#createpackage" onclick="resetval()">
                    <span><i class="fas fa-plus mr-1"></i></span>
                  </button>
                  <button href="#" class="btn btn-info" data-toggle="modal" data-target="#filterpackage">
                        ...
                        <tr>
                          <td class="text-center">
                            <div class="custom-checkbox custom-control">
                              <input type="checkbox" data-checkboxes="mygroup" class="custom-control-input" id="checkbox-<?php echo $sno; ?>" name="mark" value="<?php echo $val->package_id; ?>">
                          ...
                          <td>
                            ...
                            <strong>Duration :</strong> <span><?php echo $val->duration; ?></span> </br>
  ...
  <!-- Create course -->
  <div class="modal fade" id="createpackage" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title text-dark" id="myLargeModalLabel">Create Package</h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
        <form enctype="multipart/form-data" class="document-createmodal" method="post" name="package_add" id="package_add">
          ...
          <div class="modal-body">
            <div class="card">
              ...
              <div class="form-group col-md-4 col-sm-12">
                ...
                <div class="form-group col-md-4 col-sm-12">
                  <label for="pwd">Package Name:<span style="color: red;">*</span></label>
                  <input class="form-control" type="text" id="package_name" name="package_name" placeholder="Enter SubCourse Name" required>
                </div>
                <div class="form-group col-md-4 col-sm-12">
                  <label for="pwd">Package Code:<span style="color: red;">*</span></label>
                  <input class="form-control" type="text" id="package_code" name="package_code" placeholder="Enter SubCourse Code" required>
                </div>
                <div class="form-group col-md-4 col-sm-12">
                ...
                <!-- <div class="form-group col-md-4 col-sm-12">
                  ...
                  <input class="form-control" type="text" id="percentage" name="percentage" placeholder="Enter Percentage" required>
                </div>  -->
                <div class="form-group col-md-4 col-sm-12">
  ...
  <!-- Filter Course -->
  <div class="modal fade" id="filterpackage" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
        <form method="post" action="<?php echo base_url(); ?>AdminSettings/package">
            <div class="card">
              <div class="branch-items row mb-2">
            ...
            <a class="btn btn-light text-dark" href="<?php echo base_url(); ?>AdminSettings/package">Reset</a>
            </div>
          </form>
      </div>
    </div>
    ...
    <script>
      $("#package_add").validate({
        ...
        submitHandler: function() {
          ...
          var form = $('#package_add')[0];
          var data = new FormData(form);

          $.ajax({
            type: "POST",
            enctype: 'multipart/form-data',
            url: "<?php echo base_url(); ?>AdminSettings/ajax_package",
            type: "post",
            data: data,
            processData: false,
            contentType: false,
      ...
      function co_upd(package_id) {
        $.ajax({
          url: "<?php echo base_url(); ?>AdminSettings/get_record_package",
          type: "post",
          data: {
          ...
          success: function(resp) {
            ...
            var package_name = data['single_record'].package_name;
            var package_code = data['single_record'].package_code;
      ...
      function co_status_upd(package_id, status) {
        $.ajax({
