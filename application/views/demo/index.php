 ...
 <!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
   ...
   <!--  <section class="content-header">
      ...
      // print_r($upd_see);
      // die;
       $nos=0; foreach($upd_see as $val) { if($val->discard=="0") { if(in_array($val->branch_id,$branch_ids)  && in_array($val->department_id,$depart_ids) || $_SESSION['logtype']=="Super Admin" || $_SESSION['logtype']=="Faculty" || $_SESSION['logtype']=="hod") { $nos++; } } } ?> 
     <?php  if($nos!=0) {
     $dd = "";
      foreach($upd_see as $val) { if($val->discard=="0") { if(in_array($val->branch_id,$branch_ids)  && in_array($val->department_id,$depart_ids) || $_SESSION['logtype']=="Super Admin" || $_SESSION['logtype']=="Faculty"  || $_SESSION['logtype']=="hod") { 
...
<?php if(isset($_SESSION) && $_SESSION['logtype']=="Super Admin"){ ?>
  <div class="row">
<?php
...
<?php } ?>
  ...
  <div class="box box-default collapsed-box box-solid">
      <div class="box-header with-border">
          <h3 class="box-title">11 To 12 Timing Demo Students</h3>
    ...
    <div class="row">
      <input type="button" name="show_graphs" id="show_graphs" value="Show Graphs">
        <div class="col-md-4" id="graphs">
            <div class="chart-box">
      ...
      <div class="row" style="background-color:#FFF;">
        ...
        <div class="modal-dialog modal-sm">
          ...
          <div class="col-md-12">
           ...
           if($isRelavent==true || $_SESSION['logtype']== "Super Admin") {
