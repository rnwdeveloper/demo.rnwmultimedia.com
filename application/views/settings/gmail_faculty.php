        ...
        <div class="col-md-12">
          ...
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              ...
              <li class="active"><a href="#details" data-toggle="tab"><a href="<?php echo base_url(); ?>settings/gmail_faculty">Faculty mail</a></a></li>
           ...
           <!-- /.card-body -->              
            ...
            <!-- /.box-header -->
              ...
              <table id="example1" class="table table-responsive table-bordered table-striped example1">
                ...
                <tbody>
                <?php $sno=1; foreach($all_faculty as $val) { if($val->designation!='') {  ?>
                <tr>
                  <td>
                       <label class="customcheck"><?php echo $sno; ?>
                          <input type="checkbox" name="mark" value="<?php echo $val->faculty_id; ?>" id="mark">
     ...
     function mailsend()
      {
            ...
            if(id!="")
            {
              ...
              $.ajax({
                ...
                url:"<?php echo base_url() ?>settings/fetch_mail_faculty",
                type:"POST",
                data:{
                  'u_id':id
                },
