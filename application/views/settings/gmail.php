        ...
        <div class="col-md-12">
          ...
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              <li class="active"><a href="#activity" data-toggle="tab"><a href="<?php echo base_url(); ?>settings/gmail"> User Mail</a></a></li>
           ...
           <!-- /.card-body -->              
            ...
            <!-- /.box-header -->
              ...
              <table id="example1" class="table table-responsive table-bordered table-striped example1">
                ...
                <tbody>
                <?php $sno=1; foreach($all_staffDetails as $val) { if($val->designation!='') { ?>
                <tr>
                  <td>
                       <label class="customcheck"><?php echo $sno; ?>
                          <input type="checkbox" name="mark" value="<?php echo $val->user_id; ?>" id="mark">
