  ...
  <div class="col-md-12">
          ...
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              ...
              <li ><a href="#details" data-toggle="tab"><a href="<?php echo base_url(); ?>settings/gmail_all_member">All Member mail</a></a></li>
              <li  class="active"><a href="#details" data-toggle="tab"><a href="<?php echo base_url(); ?>settings/gmail_placement_company">All Placement Emails</a></a></li>
            </ul>
          </div>
          <!-- /.nav-tabs-custom -->
        </div>
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary" style="padding:20px;">
            <div class="box-header with-border">
              ...
              <div style="background: green;color: white;width: 100%;"><?php echo $this->session->flashdata('email_sent');  ?></div>
              <?php }else{ ?>
               <div style="background: red;color: white;width: 100%;"><?php echo $this->session->flashdata('email_sent_error');  ?></div>
              <?php } ?>
              <br>
                        ...
                        <div class="modal-dialog">
                          ...
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                             <form method="post" action="<?php echo base_url(); ?>settings/placement_company_email_all_data" enctype="multipart/form-data">
                                    <div class="col-md-12">
              <!-- /.card-header -->
              <div class="card-body">
                 ...
                 <div class="form-group">
                  <input class="form-control" placeholder="Password:" name="password" type="text" value="rnw#tpo2020">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  <input class="form-control" placeholder="Subject:" name="subject" value="Formal Recruitment Guidelines from RNW">
                </div>
                <div class="form-group">
                    <textarea placeholder="Description" id="compose-textarea" class="form-control" style="height: 150px;" name="description"></textarea>
                </div>
                <!--  <div class="mb-3">
            ...
            <!-- /.box-header -->
              ...
              <table id="example1" class="table table-responsive table-bordered table-striped example1">
                ...
                <tbody>
                  ...
                  <?php $no=1; foreach($all_super as $as) { ?>  
                <tr>
                  <td>
                       <label class="customcheck"><?php echo $no; ?>
                          <input type="checkbox" name="mark" value="<?php echo @$as->placement_email_id; ?>" id="mark" cl>
                   ...
                   <td><?php echo $as->Current_Status; ?></td>
     ...
     function mailsend()
      {
            ...
            if(id!="")
            {
              ...
              $.ajax({
                ...
                url:"<?php echo base_url() ?>settings/fetch_mail_all_placement_company",
                type:"POST",
                data:{
                  'u_id':id
                },
