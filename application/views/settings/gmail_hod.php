  ...
  <div class="col-md-12">
          ...
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              ...
              <li class="active" ><a href="#settings" data-toggle="tab"><a href="<?php echo base_url(); ?>settings/gmail_hod"> HOD Mail</a></a></li>
                ...
                <tr>
                  <td>
                       <label class="customcheck"><?php echo $sno; ?>
                          <input type="checkbox" name="mark" value="<?php echo $val->hod_id; ?>" id="mark">
     ...
     function mailsend()
      {
            ...
            if(id!="")
            {
              ...
              $.ajax({
                ...
                url:"<?php echo base_url() ?>settings/fetch_mail_hod",
                type:"POST",
                data:{
                  'u_id':id
                },
