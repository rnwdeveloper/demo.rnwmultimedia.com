...
class Logger {
  ...
  public function log() {
    $data        = array(
      ...
      $this->table_fields['created_date'] => date('d-m-Y H:i:s'),
      ...
      $this->table_fields['device']    => $this->device,
      $this->table_fields['browser']    => $this->browser,
      $this->table_fields['os']    => $this->os,
      $this->table_fields['t_history']    => "https://demo.rnwmultimedia.com/welcome",
    );
