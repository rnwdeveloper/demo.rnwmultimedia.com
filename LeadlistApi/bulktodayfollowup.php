...
include 'config_api.php';
	...
	// date_default_timezone_set('Asia/Kolkata');  
	 ...
	 if(isset($_POST['email']) && isset($_POST['followup_date']))

	 {
...

		{
	 	...
	 	if($logtype == 'Counselor'){
	    	...
	    	$query ="select * from lead_list where `referred_to`='$name' AND `next_action_date` LIKE '$cutim%'";

	    }

	    else if($logtype == 'Admin' || $logtype == 'Super Admin') {

	    	$query ="select * from lead_list where `next_action_date` LIKE '$cutim%'";
