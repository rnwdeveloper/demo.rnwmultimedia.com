...
$route = $_POST['route'];
$ch=curl_init('http://dndsms.vishawebsolutions.com/api/mt/SendSMS?APIKEY='.$user.'&senderid='.$senderid.'&channel='.$channel.'&DCS='.$DCS.'&flashsms='.$flashsms.'&number='.$number.'&text='.$message.'&route='.$route.'');
$data = curl_exec($ch);
...
<input type="text" id="TextBox1" name="" value="http://dndsms.vishawebsolutions.com/api/mt/SendSMS?" readonly="readonly" class="form-control">
</div>
<div class="col-md-6">
<div class="form-group">
