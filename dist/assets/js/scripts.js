...
jQuery(".extra_lead_showM").niceScroll({
  cursorcolor:"#5864bd"
}); 


jQuery(".nicescroll-rails-vr").appendTo(".extra_lead_showM");
...
$(document).ready(function () {
  $('.toggler_btn').click(function () {
    $('.navbar_menu .mobile_popup_inner').addClass('show');
    $('.navbar_menu .mobile_popup_overlay').addClass('show');
    $('body').addClass('overflow-hidden');
  });
  $('.close_btn').click(function () {
    $('.navbar_menu .mobile_popup_inner').removeClass('show');
    $('.navbar_menu .mobile_popup_overlay').removeClass('show');
    $('body').removeClass('overflow-hidden');
  })
})

$('.new_demo_carousel').carousel({
  interval: 2000
})
...
$(document).ready(function () {
  if (window.innerWidth > 768) {
    $(".main-drop-menu").hide();
    var i = 1;
    $(".open-drop-menu").click(function (e) {
      e.preventDefault();
      e.stopPropagation();
      var $this = $(this);
      $(this).prev('.open-drop-menu').find('.main-drop-menu').hide();
      $(this).next('.open-drop-menu').find('.main-drop-menu').hide();
      if (i % 2 == 1) {
    ...
    $('.main-drop-menu').click(function (e) {
      e.stopPropagation();
    });
    ...
    $('.navbar_menu').find('.open_mobile_drop_menu').on('click', function () {
      // Expand or Collapse This Panel
      $(this).next().slideToggle(600);
      // Hide The Other Panels
      $('.main-drop-menu').not($(this).next()).slideUp(600);
    });
  }
})
