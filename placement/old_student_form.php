...
// }
    ...
    $already_record = "select * from application_job where `email`='$email' AND `application_status`!='2'";
     	   	 ...
     	   	 if($num > 0 )
     	   	 {
     	   	 	...
     	   	 	?>
     	   	 	<script>window.location="old_student_form.php";
     	   	 	</script>
     	   	 	<?php
     	   	 }
     	   	 else
     	   	 {
        				...
        				header("location:testmail.php?email=$email");
		     	   	 }
		     	   	 else
		     	   	 {
			...
			<div class="row">
				...
				<div class="col-md-4">
					<div class="form-group">
						...
						<input type="text" id="email" class="form-control" placeholder="Enter Email" id="email" required name="email" />
				...
				<div class="col-md-4">
					<div class="form-group">
						...
						<input type="text" class="form-control" placeholder="Enter phone" id="phone" required name="phone"   maxlength="10" />
					</div>
