...
<body>
	...
	<div class="color-theme">
		...
		<div class="container-fluid text-center pt-3 pb-3">
            ...
            <div class="row justify-content-center">
    			...
    			<a href="https://www.rnwmultimedia.com/" target="_blank" style="display: inline-block;">

                    <img src="img/GROUP-OF-INSTITUTES.png" width="320" alt="Red & White MUltimedia Education" title="Red & White MUltimedia Education"/>
	...
	<div class="main_title">
        ...
        <div class="container">
            <button type="button" class="btn post_help" data-toggle="modal" data-target="#md">
                <img src="https://demo.rnwmultimedia.com/placement/images/helpIcon.png" height="30" width="30">
                <span><br>H<br>e<br>l<br>p</span>
            </button>
        <!--<button class="post_help" data-target="#exampleModal"  data-toggle="modal" >  -->
        <!--    <img src="https://demo.rnwmultimedia.com/placement/images/helpIcon.png" height="30" width="30">-->
        <!--    <span><br>H<br>e<br>l<br>p</span>-->
        <!--</button>-->
                    ...
                    <div class="card" style="border: none;">
                        ...
                        <div class="login-box">
                            ...
                            <div class="login-snip">
                                ...
                                <label for="tab-1" class="tab">Running Student</label>

                                <input id="tab-2" type="radio" name="tab" class="sign-up">

                                <label for="tab-2" class="tab">Alumni Student</label>
                                    ...
                                    <form method="post" action="grid_otp_checker.php">
                                        ...
                                        <div class="login">
                                            ...
                                            <div class="group text-center">
                                                ...
                                                <img src="https://demo.rnwmultimedia.com/placement/images/student.png" width="100"> 
                                            ...
                                            <div class="group text-left">
                                                ...
                                                <input  type="text" name="gr_id" id="GrId" class="input form-control" placeholder="Enter your GR ID" required=""> 
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">Student Registration Process</h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">&times;</span>
            </button>
          </div>
          <div class="modal-body">
            <iframe width="460" height="360" src="https://www.youtube.com/embed/FLph675SRy4" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
          </div>
