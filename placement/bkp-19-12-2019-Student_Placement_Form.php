...
<form method="post" enctype="multipart/form-data">
	...
	<div class="main-title">
        ...
        <input type="hidden" class="form-control" name="application_id" required  value="<?php echo $app_no; ?>" readonly/></h2>
    </div>
	<div class="form-box">
			...
			<div class="row">
				<div class="col-md-4">
					<div class="form-group">
						...
						<input type="file" class="form-control form-control-file" placeholder="" id="Signature" required />
					</div>
				</div>
				...
				<div class="col-md-12">
					<div class="form-group mb-0">
						<div class="custom-control custom-checkbox mr-sm-2">
							<input type="checkbox" class="custom-control-input" id="cust_checkbox" data-toggle="modal" data-target="#exampleModal">
...
<div class="container">
    © Copyright 2019. <a href="https://www.rnwmultimedia.com/" target="_blank">Red & White Multimedia Education</a>. All Rights Reserved.
</div>
</section>
