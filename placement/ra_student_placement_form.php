...
<html lang="en">
   ...
   <body>
      ...
      <section>
         ...
         <div class="alert alert-danger" id="already_applied_msg"><?php echo $_SESSION[
             "msg"
         ]; ?></div>
         <?php } ?>
         <?php if (isset($_SESSION["success"])) { ?>
         <div class="alert alert-success" id="suc_msg"><?php echo $_SESSION[
             "success"
         ]; ?></div>
         <?php } ?>
         ...
         <div class="form-box">
         <h3>OTP Send Your Registered Email And Mobile No</h3>
         <div class="row">
                  ...
                  <div class="row">
                     <div class="col-md-12">
                        <form method="post" >
                           ...
                           <span style="color:red;" id="error_email_otp"><?php if (
                               isset($msg_email)
                           ) {
                               echo $msg_email;
                           } ?></span>
                           ...
                           <?php } else { ?>
                           <input class="btn btn-danger" type="submit" name="submit_email" value="Verify" >
                           <?php } ?>
                        </form>
                     </div>
                  </div>
               	...
               	<div class="row">
               		...
               		<div class="col-md-12">
               			...
               			<form method="post" >
               				...
               				<span style="color:red;" id="error_mobile_otp"><?php if (
                       isset($msg_mobile)
                   ) {
                       echo $msg_mobile;
                   } ?></span>
               				...
               				<?php } else { ?>
               					...
               					<input class="btn btn-danger" type="submit" name="submit_mobile" value="Verify" >
         ...
         <div class="row justify-content-center mt-4">
            ...
            <a href="ra_confirm_student_form.php" class="btn btn-danger">Go to Form</a>
            <?php } ?>
            <!-- <?php if (isset($_SESSION["mobile_verify"]) == "verify") { ?>
               <a href="ra_confirm_student_form.php" class="btn btn-danger">Go to Form</a>
               
               <?php unset($_SESSION["mobile_verify"]);} ?>
